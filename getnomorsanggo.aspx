...
<%
	...
	If NOT Request.QueryString("sanggahid") is Nothing Then
		 sanggahid = Val(Request.QueryString("sanggahid"))
	End If
...
'==============================================================================
			SQL3 = "SELECT * FROM pengadaan_sanggah WHERE ID=" & sanggahid
'response.write(SQL3 & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					nosanggahx = myReader("nomor").ToString()
					nosanggah2x = myReader("nomor2").ToString()
					nosanggah3x = myReader("nomor3").ToString()
					nosanggah4x = myReader("nomor4").ToString()
					nosanggah5x = myReader("nomor5").ToString()
					nosanggah6x = myReader("nomor6").ToString()
				End While
			End If
			myConn.Close()
			
			If nosanggahx.length() > 2 Then
				a = 1
			End If
			If nosanggah2x.length() > 2 Then
				a = 2
			End If
			If nosanggah3x.length() > 2 Then
				a = 3
			End If
			If nosanggah4x.length() > 2 Then
				a = 4
			End If
			If nosanggah5x.length() > 2 Then
				a = 5
			End If
			If nosanggah6x.length() > 2 Then
				a = 6
			End If
...
'=====================================================================================================================
				...
				perihal0 = "SURAT PEMBERITAHUAN PEMENANG: " & perihal0
...
'=====================================================================================================================
				...
				myConn.Close()
'=====================================================================================================================
' Update nomor pada pengadaan sanggah
'=====================================================================================================================
				If a=0 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor='" & nomorq & "' WHERE ID=" & sanggahid
				Else If a=1 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor2='" & nomorq & "' WHERE ID=" & sanggahid
				Else If a=2 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor3='" & nomorq & "' WHERE ID=" & sanggahid
				Else If a=3 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor4='" & nomorq & "' WHERE ID=" & sanggahid
				Else If a=4 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor5='" & nomorq & "' WHERE ID=" & sanggahid
				Else If a=5 Then
					SQL3 = "UPDATE pengadaan_sanggah SET nomor6='" & nomorq & "' WHERE ID=" & sanggahid
				End If

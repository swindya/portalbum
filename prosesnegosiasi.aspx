...
<%
	...
	Dim jmlpre as Integer = 0
	Dim jmlpre2 as Integer = 0
	Dim jmlpre3 as Integer = 0
	Dim jmlpre4 as Integer = 0
	Dim jmlpre5 as Integer = 0
	Dim jmlpre6 as Integer = 0
...
<%
			...
			End If
			If mohonid = 0 Then
				If NOT Request.Form("negoadaid") is Nothing Then
					madaid = Request.Form("negoadaid")
					mohonid = Val(madaid)
					adaid = mohonid
				End If
			End If
			...
			End If
'-----------------------------------------------------------------------------------
			If NOT Request.Form("negonext") is Nothing Then
				statusnext = Val(Request.Form("negonext"))
			End If
...
'response.write(SQL3 & "<br>")
			If myReader.HasRows Then
				While myReader.Read()
					...
					hpsx = myReader("nilaihps").ToString()
			...
			myConn.Close()
'==============================================================================
' BACA DATA PENGADAAN USULAN -> HPS & Nilai Anggaran
'==============================================================================
...
'response.write(SQL3 & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					nilaijml = Val(nilaix)
					nilaihpsxx = Val(nilaihpsx)
				End While
			End If
			myConn.Close()
'==============================================================================
' Cari apakah data POC dengan pengadaanID sudah ada. Jika belum masukkan data
'==============================================================================
...
'response.write(SQL3 & "<br>")
			...
			If a=0 Then
				SQL4 = "INSERT INTO pengadaan_negosiasi(pengadaanID, tgl, createduser, createddatetime) VALUES(" & _
...
'response.write(SQL4)
				...
				SQL1 = "UPDATE pengadaan SET step='NEGOSIASI', tglstep='" & tglkux & "' WHERE ID=" & mohonid
'response.write(SQL1)
...
'response.write(SQL3 & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					negoidxx = myReader("ID").ToString()
					tglaanx = myReader("tgl").ToString()
					jmlpre = Val(myReader("jmlprenego").ToString())
					jmlpre2 = Val(myReader("jmlprenego2").ToString())
					jmlpre3 = Val(myReader("jmlprenego3").ToString())
					jmlpre4 = Val(myReader("jmlprenego4").ToString())
					jmlpre5 = Val(myReader("jmlprenego5").ToString())
					jmlpre6 = Val(myReader("jmlprenego6").ToString())
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			...
			<FONT face="Arial" color="#000">NEGOSIASI HARGA</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="editfrm" id="editfrm" action="editprosesnegogo.aspx" enctype="multipart/form-data">
...
%>
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input id="editnama" name="editnama" type="hidden" tabindex="3" value="<% response.write(namax) %>">
<% 
...
%>			
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top; font-size: 1.0em">
			<FONT face="Arial" color="#000">
<% 
	response.write(nilaijml.ToString("#,###")) 
%>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top; font-size: 1.0em">
			<FONT face="Arial" color="#000">
<% 
	response.write(nilaihpsxx.ToString("#,###")) 
%>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
	...
	<tr height="40px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor" name="editvendor" class="textbox" value="<% response.write(vendorx) %>" tabindex="8">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		<td style="padding-left: 20px; text-align: left; font-size: 1.0em; vertical-align: middle">
			<FONT face="Arial" color="#000">
				Nilai Penawaran
			</FONT>											
		</td>
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego" name="editnomprenego" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre.ToString("#,###")) %>" tabindex="9">
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego" name="editnompostnego" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost.ToString("#,###")) %>" tabindex="10">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="40px">
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: middle">
			<FONT face="Arial" color="#000">
				2. Nama Vendor 2
			</FONT>											
		</td>
		<td style="padding-top: 5px; padding-left: 0px; text-align: center; font-size: 1.0em; vertical-align: middle">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor2" name="editvendor2" class="textbox" value="<% response.write(vendorx2) %>" tabindex="11">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego2" name="editnomprenego2" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre2.ToString("#,###")) %>" tabindex="12">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego2" name="editnompostnego2" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost2.ToString("#,###")) %>" tabindex="13">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="40px">
		...
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor3" name="editvendor3" class="textbox" value="<% response.write(vendorx3) %>" tabindex="14">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego3" name="editnomprenego3" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre3.ToString("#,###")) %>" tabindex="15">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego3" name="editnompostnego3" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost3.ToString("#,###")) %>" tabindex="16">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="40px">
		...
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor4" name="editvendor4" class="textbox" value="<% response.write(vendorx4) %>" tabindex="17">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego4" name="editnomprenego4" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre4.ToString("#,###")) %>" tabindex="18">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego4" name="editnompostnego4" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost4.ToString("#,###")) %>" tabindex="19">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="40px">
		...
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor5" name="editvendor5" class="textbox" value="<% response.write(vendorx5) %>" tabindex="20">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego5" name="editnomprenego5" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre5.ToString("#,###")) %>" tabindex="21">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego5" name="editnompostnego5" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost5.ToString("#,###")) %>" tabindex="22">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="40px">
		...
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#BFFFF2; font-family: Arial; font-size: 1.0em; width: 600px; height: 22px" type="text" id="editvendor6" name="editvendor6" class="textbox" value="<% response.write(vendorx6) %>" tabindex="23">
			</FONT>
		</td>
		<td style="padding-top: 5px; padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	</tr>
	<tr height="38px">
		<td style="padding-left: 20px; text-align: left; font-size: 1.0em; vertical-align: middle">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnomprenego6" name="editnomprenego6" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpre6.ToString("#,###")) %>" tabindex="24">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="background-color:#FFFFAA; font-family: Arial; font-size: 1.0em; width: 150px; height:22px" type="text" id="editnompostnego6" name="editnompostnego6" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(jmlpost6.ToString("#,###")) %>" tabindex="25">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="65px">
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
				Keterangan
			</FONT>											
		</td>
		<td style="padding-top: 5px; padding-left: 0px; text-align: center; font-size: 1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-top: 5px; padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editketerangan" name="editketerangan" tabindex="26"><% response.write(ketx) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="btntab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="880px" border="0" cellspacing="0" cellpadding="0">
	<tr height="50px">
		<td colspan="5" style="padding-left: 0px; text-align: left;">
			<Input id="negoid" name="negoid" type="hidden" value="<% response.write(negoidxx) %>">
...
<%
		If statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none; font-size: 1.1em;" onclick="gotoeval()"><FONT face="Arial" color="#000">N K P</FONT></a>
<%
		End If
%>
		</td>
...
<form name="gotoevalfrm" id="gotoevalfrm" action="prosesnkp.aspx" method="post" enctype="multipart/form-data">
	<input type="hidden" id="mcuserid" name="mcuserid" value="<% Response.Write (userid) %>">

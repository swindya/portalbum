...
<%			
			...
			If NOT Request.QueryString("jenis") is Nothing Then
				 jenissudin = Request.QueryString("jenis")
			End If
...
<%
			...
			SQL1 = "SELECT * FROM [suratdinas] WHERE ID=" & suratid	
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					jenisxx = myReader("jenissurat").ToString()
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">SURAT</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="editfrm" id="editfrm" action="suratdinas.aspx" enctype="multipart/form-data">
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
<%
					response.write(jenisxx.toUpper())
%>		
			</FONT>
		</td>
...
%>			</FONT>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
<%
				response.write(tujuanxx.toUpper())
%>				
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
...
<form method="post" name="suratbarufrm" id="suratbarufrm" action="suratdinas.aspx" enctype="multipart/form-data">
	<input type="hidden" id="statusbaru" name="statusbaru" value="1">
	<input type="hidden" id="jenis" name="jenis" value="<% response.write(jenissudin) %>">
</form>

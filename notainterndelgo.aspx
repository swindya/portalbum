...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delnotinid") is nothing Then
		notinid = Request.Form("delnotinid")
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM notin WHERE (ID=" & notinid & ")"
'response.write(SQL1)					
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					nonotinxx = myReader("nomor").ToString()
					...
					jenisundxx = Val(myReader("undangan").ToString())
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO lognotinhapus (notinID, nourut, tglnotin, tglinput, rubrik, tahun, klp, createduser, tujuan," & _
						"perihal, cc, nomor, divisi, createddate, namafile, namafolder, undangan, tglhapus, userhapus) VALUES(" & _
						notinid & "," & nourutxx & ",'" & tglxx & "','" & tglinputxx & "','" & rubrikxx & "'," & tahunxx & _
						"," & klpxx & "," & cuserxx & ",'" & tujuanxx & "','" & perihalxx & "','" & tembusanxx & "','" & _
						nonotinxx & "'," & divisixx & ",'" & cdatexx & "','" & namafilexx & "','" & namafolderxx & "'," & _
...
' Hapus Data
'=============================================================================================				
				SQLdel = "DELETE FROM notin WHERE ID=" & notinid
...
<meta http-equiv="refresh" content="0;url=notaintern.aspx" />
</body>
</html>
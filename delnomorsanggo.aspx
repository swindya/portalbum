...
'=====================================================================================================================
			...
			If nomorke=2 Then
				SQL1 = "UPDATE pengadaan_sanggah SET nomor2='' WHERE ID=" & sanggahid
			Else If nomorke=3 Then
				SQL1 = "UPDATE pengadaan_sanggah SET nomor3='' WHERE ID=" & sanggahid
			Else If nomorke=4 Then
				SQL1 = "UPDATE pengadaan_sanggah SET nomor4='' WHERE ID=" & sanggahid
			Else If nomorke=5 Then
				SQL1 = "UPDATE pengadaan_sanggah SET nomor5='' WHERE ID=" & sanggahid
			Else If nomorke=6 Then
				SQL1 = "UPDATE pengadaan_sanggah SET nomor6='' WHERE ID=" & sanggahid
			End If
			...
			SQL2 = "DELETE FROM surat WHERE nomor='" & nomor0 & "'"

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("anostep") is nothing Then
		nostepku = Request.Form("anostep")
	End If
	
	If NOT Request.Form("aposisi") is nothing Then
		posisiku = Request.Form("aposisi")
	End If
	
	If NOT Request.Form("aadaid") is nothing Then
		angid = Request.Form("aadaid")
	End If
...
'=========================================
			If nostepku=1 Then
				SQL1 = "INSERT INTO pengadaan1 (pengadaanID, klp, divisi, posisi, createddate, createduser) VALUES(" & _
					angid & "," & klpx & "," &	divx & "," & posisiku & ",GETDATE()," & user0 & ")"
			Elseif nostepku=2 Then
				SQL1 = "INSERT INTO pengadaan2 (pengadaanID, klp, divisi, posisi, createddate, createduser) VALUES(" & _
					angid & "," & klpx & "," &	divx & "," & posisiku & ",GETDATE()," & user0 & ")"
			Elseif nostepku=3 Then
				SQL1 = "INSERT INTO pengadaan3 (pengadaanID, klp, divisi, posisi, createddate, createduser) VALUES(" & _
					angid & "," & klpx & "," &	divx & "," & posisiku & ",GETDATE()," & user0 & ")"
			Elseif nostepku=4 Then
				SQL1 = "INSERT INTO pengadaan4 (pengadaanID, klp, divisi, posisi, createddate, createduser) VALUES(" & _
					angid & "," & klpx & "," &	divx & "," & posisiku & ",GETDATE()," & user0 & ")"
			Elseif nostepku=5 Then
				SQL1 = "INSERT INTO pengadaan5 (pengadaanID, klp, divisi, posisi, createddate, createduser) VALUES(" & _
					angid & "," & klpx & "," &	divx & "," & posisiku & ",GETDATE()," & user0 & ")"
			End If
...
'=========================================
			b = Val(nostepku)
			c = b + 1
			SQL2 = "UPDATE pengadaan SET nostep=" & c & " WHERE ID=" & angid
'response.write(SQL2)			

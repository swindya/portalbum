...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delsuratdinasid") is nothing Then
		suratid = Request.Form("delsuratdinasid")
	End If
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logsuratdinashapus (suratdinasID, nourut, tglsuratdinas, jenissurat, rubrik, tahun, klp, createduser, tujuan," & _
						"perihal, cc, nomor, divisi, createddate, namafile, namafolder, undangan, tglhapus, userhapus) VALUES(" & _
						suratid & "," & nourutxx & ",'" & tglxx & "','" & jenisxx & "','" & rubrikxx & "'," & tahunxx & _
						"," & klpxx & "," & cuserxx & ",'" & tujuanxx & "','" & perihalxx & "','" & tembusanxx & "','" & _
						nosuratxx & "'," & divisixx & ",GETDATE(),'" & namafilexx & "','" & namafolderxx & "'," & _
						jenisundxx & ",'" & tglsaiki & "'," & idq & ")"
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM suratdinas WHERE ID=" & suratid
'response.write(SQL0 & "<br>")
...
<meta http-equiv="refresh" content="0;url=suratdinas.aspx?jenis=<% response.write(jenissu)%>" />
</body>
</html>
...
'-----------------------------------------------------------------------------------
			...
			If mohonid = 0 Then
				If NOT Request.Form("evaladaid") is Nothing Then
					 madaid = Request.Form("evaladaid")
					 mohonid = Val(madaid)
				End If
			End If
			adaid = mohonid
'-----------------------------------------------------------------------------------
			...
			End If
			If userid = 0 Then
				If NOT Request.Form("evaluserid") is Nothing Then
					userid = Val(Request.Form("evaluserid"))
				End If
			End If				
			If userid = 0 Then
			...
			End If
'-----------------------------------------------------------------------------------
			If NOT Request.Form("evalnext") is Nothing Then
				statusnext = Val(Request.Form("evalnext"))
			End If
...
'==============================================================================
			SQL3 = "SELECT * FROM pengadaan_evaluasi WHERE pengadaanID=" & mohonid
'response.write(SQL3)
			myCmd.CommandText = SQL3
			myConn.Open()
			myReader = myCmd.ExecuteReader()
			...
			If a=0 Then
				SQL4 = "INSERT INTO pengadaan_evaluasi(pengadaanID, tgl, createduser, createddatetime) VALUES(" & _
...
'response.write(SQL4)
				...
				SQL1 = "UPDATE pengadaan SET step='EVALUASI', tglstep='" & tglkux & "' WHERE ID=" & mohonid
'response.write(SQL1)
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			...
			<FONT face="Arial" color="#000">EVALUASI ADM & TEKNIS</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="editfrm" id="editfrm" action="editprosesevaluasigo.aspx" enctype="multipart/form-data">
...
%>			
	...
	<tr height="35px">
		...
		<td style="font-family: Arial; padding-left: 0px; text-align: left; vertical-align: top; font-size: 1.0em;">
			<FONT face="Arial" color="#000">
<%
...
%>
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editketerangan" name="editketerangan" tabindex="7"><% response.write(ketx) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="btntab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="880px" border="0" cellspacing="0" cellpadding="0">
	<tr height="50px">
		<td colspan="5" style="padding-left: 0px; text-align: left;">
			<Input id="pocid" name="pocid" type="hidden" value="<% response.write(pocidxx) %>">
...
<%
		If statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none; font-size: 1.1em;" onclick="gotoeval()"><FONT face="Arial" color="#000">Negosiasi Harga</FONT></a>
<%
		End If
%>
		</td>
...
<table id="allbtn" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="880px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="0px">
		<td colspan="4">
			...
			<input type="hidden" id="evalnext" name="evalnext" value="<% response.write(statusnext) %>">
		</td>
	</tr>
</table>
</form>
...
<form name="gotoevalfrm" id="gotoevalfrm" action="prosesnegosiasi.aspx" method="post" enctype="multipart/form-data">
	<input type="hidden" id="mcuserid" name="mcuserid" value="<% Response.Write (userid) %>">

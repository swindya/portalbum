...
<%			
			If Request.Form("pagenos") isNot Nothing Then
				pageno = Request.Form("pagenos")
				hal = Cint(pageno)
			End If
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If namanppr.length()>0 Then
				namanppstr = " AND ([user].nama LIKE '%" & namanppr & "%' OR [user].idemployee LIKE '%" & namanppr & "%')"
			End If
...
<table id="databarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 560px" type="text" id="barunama" name="barunama" class="textbox" onchange="getnama(this.value);" tabindex="1">	
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 130px" type="text" id="barunpp" name="barunpp" class="textbox" onchange="getnama(this.value);" tabindex="2">	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
		</td>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="background-color:#FFF9B9; font-family: Calibri; font-size: 1.0em; width: 200px" type="password" id="barupwd" name="barupwd" class="textbox" tabindex="12">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="background-color:#FFF9B9; font-family: Calibri; font-size: 1.0em; width: 200px" type="password" id="barupwd2" name="barupwd2" class="textbox" tabindex="13">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 560px" type="text" id="editnama" name="editnama" class="textbox" tabindex="1">	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
<%
			If levelaksesq < 2 Then
%>
				<input style="font-family: Calibri; font-size: 1.0em; width: 130px" type="text" id="editnpp" name="editnpp" class="textbox" tabindex="2" disabled>	
<%
			ElseIf levelaksesq > 1 Then
%>
				<input style="font-family: Calibri; font-size: 1.0em; width: 130px" type="text" id="editnpp" name="editnpp" class="textbox" tabindex="2">
<%
			End If
%>
			</FONT>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="background-color:#FFF9B9; font-family: Calibri; font-size: 1.0em; width: 200px" type="password" id="editpwd" name="editpwd" class="textbox" value="11111111" tabindex="11">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="background-color:#FFF9B9; font-family: Calibri; font-size: 1.0em; width: 200px" type="password" id="editpwd2" name="editpwd2" class="textbox" value="11111111" tabindex="12">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#CAFFEB">
	...
	<tr height="35px">
		<td style="padding-left: 30px; text-align: left; font-size: 0.9em; vertical-align: top" width="200px">
			<FONT face="Calibri" color="#000">
				Divisi
			</FONT>											
		</td>
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="600px">
			<FONT face="Calibri" color="#000">
				<!--input style="font-family: Calibri; font-size: 1.0em; width: 560px" type="text" id="barupengirim" name="barupengirim" class="textbox" onchange="getnama(this.value);" tabindex="4"-->
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				...
				<div>
					...
					<input style="padding-right: 10px; text-align: left; font-size: 0.9em; width: 400px" type="text" id="namanpp" name="namanpp" class="textbox" value="<% Response.Write(namanppr) %>">
				</div>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="300px"><b>NAMA</b></td>            
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="80px"><b>NPP</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="80px"><b>DIVISI</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="100px"><b>KELOMPOK</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="190px"><b>UNIT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="200px"><b>POSISI</b></td>
...
%>
		...
		<td style="padding-left: 10px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (namaz(i).ToUpper()) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (nppz(i)) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (divz(i)) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (klpz(i)) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (unitz(i)) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (posisiz(i)) %></td>
...
%>
		<td style="padding-left: 0px; padding-top: 5px; font-family: Calibri; font-size: 0.9em;text-align: center; vertical-align: top;">
			...
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/delete4.png" OnClick="hapussurat(<% Response.Write (idz(i)) %>);" height="26px" width="25px"/><br/>
		</td>
<%
		End If
%>

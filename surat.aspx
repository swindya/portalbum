...
function hidedatabaru()
{
	...
	document.getElementById("uploadbtntab").style.display = "block";
	//document.getElementById("clearbtn").style.display = "none";
	//document.getElementById("filtertab").style.display = "none";
}
</script>
...
<script>
function editdatax(id, nosurat, tgl, jenis, perihal, rubrik, tujuan, tembusan, jenisundangan, namafile, namafolder, extens, wrnama, wrnpp, namaklp, userklp)
{
//alert(nosurat);
	document.getElementById("databarutab").style.display = "none";
	...
	//document.getElementsByName("namanpp")[0].value = wrnama + " (" + wrnpp + ") - " + namaklp;
	document.getElementById('namapp').innerHTML = "<i>Petugas Input :</i> &nbsp;&nbsp;" + wrnama + " (" + wrnpp + ") - " + namaklp;
	if (jenis==1)
	{
		document.getElementById('editjenis').innerHTML = "Biasa";
	}
	else if (jenis==2)
	{
		document.getElementById('editjenis').innerHTML = "Rahasia";
	}
	...
	if (jenisundangan==1)
	{
		...
		//document.getElementById("editjunda").checked = 1;
		//document.getElementById("editjunda").click();
	}
	else
	{
...
<%			
			...
			If NOT Request.Form("statusfilter") is Nothing Then
				statusf = Val(Request.Form("statusfilter"))
			End If
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If perihal.length()>0 Then
				perihalstr = " AND (nomor LIKE '%" & perihal & "%' OR perihal LIKE '%" & perihal & "%' OR tujuan LIKE '%" & perihal & "%')"
			End If
...
' Data SURAT
'============================================================================
			SQL0 = "SELECT ID FROM [surat] WHERE (ID>0" & perihalstr & tglstr & klpstr & ") ORDER BY tglsurat DESC,nourut DESC"
			'If namaklpq.ToUpper() = "BUM" Then
			If Val(levelaksesq)=1 Then
				SQL0 = "SELECT ID FROM [surat] WHERE (ID>0" & perihalstr & tglstr & " AND klp=" & klpq & ") ORDER BY tglsurat DESC,nourut DESC"
			ElseIf Val(levelaksesq) > 1 Then
				SQL0 = "SELECT ID FROM [surat] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglsurat DESC,nourut DESC"
			End If
			SQLexport = "SELECT * FROM [surat] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglsurat ASC,nourut ASC"
...
'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			...
			Dim jmlu as Integer = 0
			Dim uid(1000) as String
			Dim usurat(1000) as Integer
			Dim usekre(1000) as Integer
			
			'SQL0 = "SELECT * FROM [userX]"
			'myCmd.CommandText = SQL0
			'myConn.Open()
			'myReader = myCmd.ExecuteReader()
            ...
            '    While myReader.Read()
			'		a = a + 1
			'		uid(a) = myReader("user_idemployee").ToString()
			'		usurat(a) = Val(myReader("user_surat").ToString())
			'		usekre(a) = Val(myReader("user_sekretaris").ToString())
			'	End While
			'End If
			'myConn.Close()
			'jmlu = a
			...
			'For a=1 to jmlu
			'	myConn.Open()
			'	SQL1 = "UPDATE [user] SET menusurat=" & usurat(a) & ", menusekretaris=" & usekre(a) & _
			'			" WHERE idemployee='" & uid(a) & "'"
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-weight: 500; font-size: 1.5em">
			<FONT face="Arial" color="#666666">DAFTAR SURAT</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="barufrm" id="barufrm" action="surataddgo.aspx" enctype="multipart/form-data">
<%
...
%>
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#44AA44">>> SURAT BARU</FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle" width="700px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" type="text" name="barutgl" id="barutgl" class="tcal" tabindex="1"/>
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 130px; height: 25px;" id="soflow11" name="barujenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
	...
	<tr height="60px">
		...
		<td style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 55px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="baruperihal" name="baruperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 130px; height: 25px" id="soflow12" name="barupengirim" data-placeholder="Jenis" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 640px; height: 18px" type="text" id="barutujuan" name="barutujuan" class="textbox" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		<td style="padding-left: 0px; padding-top: 3px; text-align: left; font-size: 0.9em; vertical-align: middle">
			<FONT face="Arial" color="#000">
				Undangan
			</FONT>											
		</td>
		<td style="padding-left: 0px; padding-top: 3px; text-align: center; font-size: 0.9em; vertical-align: middle">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-left: 0px; padding-top: 3px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
...
<form method="post" name="editfrm" id="editfrm" action="surateditgo.aspx" enctype="multipart/form-data">
<%
	If statusbaru=0 Then
%>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<label id="editjenis" style="font-size: 0.9em; font-weight: 500"></label>			
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="70px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top; font-size:1.0em;">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 55px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 25px;" id="soflow22" name="editpengirim" data-placeholder="Pengirim" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
			for b=1 to jmlrubrik
%>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 640px" type="text" id="edittujuan" name="edittujuan" class="textbox" onchange="getnama(this.value);" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 640px" type="text" id="edittembusan" name="edittembusan" class="textbox" onchange="getnama(this.value);" tabindex="6">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		<td style="padding-left: 0px; padding-top: 3px; text-align: left; font-size: 0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				Undangan
			</FONT>											
		</td>
		<td style="padding-left: 0px; padding-top: 3px; text-align: center; font-size: 0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-left: 0px; padding-top: 3px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<div style="text-align:left;margin-top:0%">
					<div class="container2">
						<label class="switch switch-green">
...
<%
	If statusbaru=0 Then
%>
<form method="post" name="filterfrm" id="filterfrm" action="surat.aspx" enctype="multipart/form-data">
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#CAFFEB">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="920px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" type="text" name="tglperiode1" id="tglperiode1" class="tcal" value="<% response.write(tgl1) %>" tabindex="1"/>
			&nbsp;&nbsp; s/d &nbsp;&nbsp;
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" type="text" name="tglperiode2" id="tglperiode2" class="tcal" value="<% response.write(tgl2) %>" tabindex="1"/>
			</FONT>
		</td>
	</tr>
	<tr height="35px">
...
<table id="barubtntab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
	<tr height="38px" align="left">
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="430px">
		</td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="150px">
<%
		'If namaklpq.ToUpper() = "BUM" Then
		If Val(levelaksesq)>1 AND Val(suratq)=1 Then
%>
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="90px"><b>JENIS</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="120px"><b>NO SURAT</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="350px"><b>PERIHAL</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="270px"><b>TUJUAN</b></td>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM [surat] WHERE ID=" & idz(i)			
		myCmd.CommandText = SQL1
...
'================================================================================
		...
		nosuratxx = rubrikxx & nourutxx
		
		SQLUP = "UPDATE surat SET nomor='" & rubrikxx & nourutxx & "' WHERE ID=" & idz(i)
		...
		datastrxx = idxx & ",'" & nosuratxx & "','" & tglsu & "','" & jenisxx & "','" & perihalxx & "','" & rubrikxx & "','" & tujuanxx & "','" & _
						tembusanxx & "','" & jenisundanganxx & "','" & namafilexx & "','" & namafolderxx & "','" & extens & "','" & writenama.ToUpper() & "','" & _
						writenpp & "','" & namaklpxx & "','" & namaklpq & "'"
...
<%
		If n=0 Then
			n = 1
%>
	<tr id="row<% Response.Write(bb)%>" STYLE="background-color: #FFFFFF" height="34px">
<%
		Elseif n=1 Then
			n = 0
%>
	<tr id="row<% Response.Write(bb)%>" STYLE="background-color: #E5FFFB" height="34px">
<%
		End If
%>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (jenissuratxx) %></td>
		...
		<!--td style="padding-left: 0px; font-family: Arial; font-size: 1.0em;text-align: center;">
		...
		<td style="padding-left: 0px; padding-top: 5px; font-family: Arial; font-size: 0.9em; text-align: center; vertical-align: top;">
			...
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/edit2.jpg" height="22px" width="22px"/><br/>
			</a>
		</td>
<%
		'If namaklpq.ToUpper() = "BUM" Then
...
%>
		<td style="padding-left: 0px; padding-top: 5px; font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top;">
			...
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/delete4.png" OnClick="hapussurat(<% Response.Write (idxx) %>);" height="22px" width="22px"/><br/>
		</td>
<%
		End If
%>
...
<form method="post" name="delfrm" id="delfrm" action="suratdelgo.aspx" enctype="multipart/form-data">
...
<form method="post" name="exportfrm" id="exportfrm" action="suratdownloadgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="suratsql" name="suratsql" value="<% response.write(SQLexport) %>">
</form>

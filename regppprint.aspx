...
function databarux()
{
	...
	document.forms["regppbarufrm"].submit();
}
</script>
...
' Data Reg Voucher
'============================================================================
			SQL0 = "SELECT * FROM [regpp] WHERE ID=" & id0
...
%>			
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top; font-size: 1.2em;">
...
%>
	...
	<tr height="40px">
		<td colspan="4" style="padding-left: 0px; text-align: left;">
			<a href="#" class="css-button-3" style="text-decoration: none; font-size: 1.1em" onclick="databarux();">
...
<form method="post" name="regppbarufrm" id="regppbarufrm" action="regpp.aspx" enctype="multipart/form-data">

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("editnotinid") is nothing Then
		notinid = Request.Form("editnotinid")
	End If
	...
	If NOT Request.Form("editju") is nothing Then
		pengadaan = Request.Form("editada")
	End If	
...
'=========================================
			...
			If statusfile=0 Then
				SQL0 = "UPDATE notin SET tglnotin='" & tgl0 & "',tglinput='" & tglinputq & "', jenis=" & jenis0 & _
						", rubrik='" & pengirim0 & "', tahun=" & tahun & ", klp=" & klpq & ", createduser=" & idq & _
						", tujuan='" & tujuan0.ToUpper() & "', perihal='" & perihal0.ToUpper() & "', cc='" & tembusan0.ToUpper() & "', nomor='" & _
						nomorq & "', jam='" & jamsaiki & "', divisi=" & divq & ", createddate='" & tglinputq & _
						"', undangan=" & jenisund0 & ", statuspengadaan=" & pengadaan & " WHERE (ID=" & notinid & ")"
			ElseIf statusfile=1 Then
				SQL0 = "UPDATE notin SET tglnotin='" & tgl0 & "',tglinput='" & tglinputq & "', jenis=" & jenis0 & _
						...
						", statuspengadaan=" & pengadaan & " WHERE (ID=" & notinid & ")"
			End If

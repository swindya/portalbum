...
'=========================================
			SQL0 = "INSERT INTO pengadaan (tglmohon, klp, divisi, nama, jenispengadaan, jenisanggaran, tahun, " & _
					"namafolder, namafilesurat, namafileip, namafiletor, namafilerab, statuspass, nostep, createduser, " & _
					"createddate, statusrevisi) VALUES('" & tgl0 & "'," & klpq & "," &	divq & ",'" & nama0 & "','" & jenis0 & _
					"','" & jenisanggaran0 & "'," & tahun & ",'" & folder2 & "','" & nfsurat & "','" & nfip & "','" & nftor & _
					"','" & nfrab & "',0,1," & idq & ",GETDATE(),0)"
'response.write(SQL0)			
...
<meta http-equiv="refresh" content="20;url=permohonan.aspx" />
</body>
</html>
...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("tunid") is Nothing Then
		nkpid = Val(Request.Form("tunid"))
	End If
	...
	If NOT Request.Form("editvendor") is Nothing Then
		namavendor = Request.Form("editvendor")
	End If
	...
	If NOT Request.Form("statusnext") is nothing Then
		statusnextx = Val(Request.Form("statusnext"))
	End If	
...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaan_penunjukan] WHERE (ID=" & nkpid & ")"
...
'==================================================================================================================
			If dataexist=1 Then
				'SQL0 = "UPDATE pengadaan_penunjukan SET tgl='" & tglx & "', vendor='" & namavendor & "', keterangan='" & ket & "', namafolder='" & _
				'folder2 & "'" & nfsuratz & nfipz & " WHERE (ID=" & nkpid & ")"
				SQL0 = "UPDATE pengadaan_penunjukan SET tgl='" & tglx & "', keterangan='" & ket & "', namafolder='" & _
				folder2 & "'" & nfsuratz & nfipz & " WHERE (ID=" & nkpid & ")"
...
<meta http-equiv="refresh" content="0;url=prosespenunjukan.aspx?padaid=<% response.write(adaid) %>&statusnext=<% response.write(statusnextx) %>" />
</body>
</html>
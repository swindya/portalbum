...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delrubid") is nothing Then
		rubid = Request.Form("delrubid")
	End If
...
'==========================================================================
			a = 0
			SQL0 = "SELECT * FROM [rubrik] WHERE ID=" & rubid
			...
			If a=1 Then
				SQL0 = "DELETE FROM rubrik WHERE ID=" &rubid		
				myCmd.CommandText = SQL0
				myConn.Open()
				myReader = myCmd.ExecuteReader()
				myConn.Close()
...
<meta http-equiv="refresh" content="0;url=rubrik.aspx" />
</body>
</html>
...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("editrpid") is nothing Then
		rpid = Request.Form("editrpid")
	End If
...
'=========================================
			...
			SQL0 = "UPDATE regpp SET tgl='" & tgl0 & "', perihal='" & perihal0 & "', nominal=" & jmlnom & _
			filestr & " WHERE (ID=" & rpid & ")"

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("barunamadiv") is nothing Then
		namadiv = Request.Form("barunamadiv")
	End If
	
	If NOT Request.Form("barukodediv") is nothing Then
		kodediv = Request.Form("barukodediv")
	End If
...
'==========================================================================
			a = 0
			SQL0 = "SELECT * FROM [divisi] WHERE div_nama='" & kodediv & "'"
			...
			If a=0 Then
				SQL0 = "INSERT INTO [divisi] (div_nama, div_namalengkap) VALUES('" & kodediv & "','" & namadiv & "')"			
				myCmd.CommandText = SQL0
				myConn.Open()
				myReader = myCmd.ExecuteReader()
				myConn.Close()

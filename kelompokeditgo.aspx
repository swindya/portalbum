...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("editdivid") is nothing Then
		divid = Val(Request.Form("editdivid"))
	End If
	If NOT Request.Form("editklpid") is nothing Then
		id = Val(Request.Form("editklpid"))
	End If
	If NOT Request.Form("editkelompok") is nothing Then
		namaklp = Request.Form("editkelompok")
	End If
	If NOT Request.Form("editket") is nothing Then
		ketklp = Request.Form("editket")
	End If
...
'==========================================================================
			a = 0
			SQL0 = "SELECT * FROM [klp] WHERE ID=" & id
'response.write(SQL0)
			...
			If a=1 Then
				...
				SQL1 = "UPDATE [klp] SET klp_nama='" & namaklp & "', klp_ket='" & ketklp & "' WHERE ID=" & id			

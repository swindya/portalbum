...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaan_evaluasi] WHERE (ID=" & pocid & ")"
...
'==================================================================================================================
			If dataexist=1 Then
				SQL0 = "UPDATE pengadaan_evaluasi SET tgl='" & tglx & "', keterangan='" & ket & "', namafolder='" & _
...
<meta http-equiv="refresh" content="0;url=prosesevaluasi.aspx?statusnext=<% response.write(statusnext) %>&padaid=<% response.write(adaid) %>" />
</body>
</html>
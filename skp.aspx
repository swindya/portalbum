...
function hapusskp(id)
{
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			document.getElementsByName("delskpid")[0].value = id;
...
function savebaru()
{
	...
	var ketua = document.getElementsByName("baruketua")[0].value;
	var waka = document.getElementsByName("baruwaka")[0].value;
	var anggota = document.getElementsByName("baruanggota")[0].value;

	var perihal = document.getElementsByName("baruperihal")[0].value;
	//var pengirim = document.getElementsByName("barupengirim")[0].value;
	if ((tgl==null || tgl=="") || (ketua==null || ketua=="") || (perihal==null || perihal=="") || (waka==null || waka=="") || (anggota==null || anggota==""))
	{
...
<script>
function editdatax(id, noskp, tgl, perihal, ketuanama, ketuajbtn, wakanama, wakajbtn, anggota, namafile, namafolder, extens, statusbum, wrnama, wrnpp, namaklp, userklp)
{
//alert(id + "-" + wrnpp);
	document.getElementById("databarutab").style.display = "none";
	...
	document.getElementsByName("editskpid")[0].value = id;
	document.getElementsByName("edittgl")[0].value = tgl;
	//document.getElementsByName("editnomor")[0].value = nomemo;
	document.getElementById('nomor').innerHTML = noskp;
	document.getElementsByName("editperihal")[0].value = perihal.toUpperCase();
	document.getElementsByName("editketua")[0].value = ketuanama;
	document.getElementsByName("editketuajab")[0].value = ketuajbtn;
	document.getElementsByName("editwaka")[0].value = wakanama;
	document.getElementsByName("editwakajab")[0].value = wakajbtn;
	document.getElementsByName("editanggota")[0].value = anggota;
...
<%
	...
	Dim namaketuaxx as String
	Dim namawakaxx as String
	...
	Dim ketuajbtnxx as String = ""
	Dim wakajbtnxx as String = ""
	
	Dim setmenu as String = "skp"
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If perihal.length()>0 Then
				perihalstr = " AND (perihal LIKE '%" & perihal & "%' OR nomor LIKE '%" & perihal & "%' OR ketua LIKE '%" & _
							perihal & "%' OR wakilketua LIKE '%" & perihal & "%')"
			End If
...
' Data MEMO
'============================================================================
			SQL00 = "SELECT ID FROM surat_kp WHERE (ID>0 AND divisi=" & divq & perihalstr & tglstr & ") ORDER BY tglskp DESC"
			If Val(posisiq) <= 4 Then
				SQL00 = "SELECT ID FROM surat_kp WHERE (ID>0 AND divisi=" & divq & perihalstr & tglstr & ") ORDER BY tglskp DESC"
			End If
			'If namaklpq.ToUpper() = "BUM" Then
			If Val(levelaksesq)>1 Then
				SQL00 = "SELECT ID FROM [surat_kp] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglskp DESC"
			End If
			SQLexport = "SELECT * FROM [surat_kp] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglskp ASC,nourut ASC"

'response.write("1). " & SQL00 & "<br>")
			myCmd.CommandText = SQL00
			myConn.Open()
...
'response.write("2)." & SQL1 & "<br>")
'response.write(myrubrik)
'================================================================================
'==========================================================================
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">DAFTAR SURAT KEPUTUSAN (SK)</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="barufrm" id="barufrm" action="skpaddgo.aspx" enctype="multipart/form-data">
<%
...
%>
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#44AA44">>> SK BARU</b></FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="65px">
		...
		<td colspan="2" style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 55px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="baruperihal" name="baruperihal" tabindex="2"></textarea>
			</FONT>
		</td>
	</tr>
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" placeholder="Nama Ketua" type="text" id="baruketua" name="baruketua" class="textbox" onchange="getnama(this.value);" tabindex="3">		
			</FONT>
		</td>
		<td style="padding-left: 10px; text-align: left; vertical-align: middle"">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px;" placeholder="Jabatan Ketua" type="text" id="baruketuajab" name="baruketuajab" class="textbox" tabindex="4">		
			</FONT>		
		</td>
	</tr>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" placeholder="Nama Wakil Ketua" type="text" id="baruwaka" name="baruwaka" class="textbox" onchange="getnama(this.value);" tabindex="4">		
			</FONT>
		</td>
		<td style="padding-left: 10px; text-align: left; vertical-align: middle">										
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" placeholder="Jabatan Wakil Ketua" type="text" id="baruwakajab" name="baruwakajab" class="textbox" onchange="getnama(this.value);" tabindex="4">		
			</FONT>
		</td>
	</tr>
	<tr height="38px">
		...
		<td colspan="2" style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 640px; height: 18px" type="text" id="baruanggota" name="baruanggota" class="textbox" tabindex="5">
			</FONT>
		</td>
	</tr>
	<tr height="35px">
...
<form method="post" name="editfrm" id="editfrm" action="skpeditgo.aspx" enctype="multipart/form-data">
<%
	If statusbaru=0 Then
%>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle" width="400px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" type="text" name="edittgl" id="edittgl" STYLE="color: #000000; background-color: #FFFFFF;" tabindex="1" disabled>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="400px">										
		</td>
	...
	<tr height="65px">
		...
		<td colspan="2" style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 55px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" tabindex="2"></textarea>
			</FONT>
		</td>
	</tr>
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" type="text" id="editketua" name="editketua" class="textbox" onchange="getnama(this.value);" tabindex="3">		
			</FONT>
		</td>
		<td style="padding-left: 10px; text-align: left; vertical-align: middle"">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" type="text" id="editketuajab" name="editketuajab" class="textbox" onchange="getnama(this.value);" tabindex="4">		
			</FONT>		
		</td>
	</tr>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" type="text" id="editwaka" name="editwaka" class="textbox" onchange="getnama(this.value);" tabindex="4">		
			</FONT>
		</td>
		<td style="padding-left: 10px; text-align: left; vertical-align: middle">										
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 380px; height: 18px" type="text" id="editwakajab" name="editwakajab" class="textbox" onchange="getnama(this.value);" tabindex="4">		
			</FONT>
		</td>
	</tr>
	<tr height="38px">
		...
		<td colspan="2" style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 640px; height: 18px" type="text" id="editanggota" name="editanggota" class="textbox" tabindex="5">
			</FONT>
		</td>
	</tr>
	<tr height="35px">
	...
	<tr height="30px">
		<td colspan="4">
			<input type="hidden" id="editskpid" name="editskpid">
...
<%
	If statusbaru=0 Then
%>
<form method="post" name="filterfrm" id="filterfrm" action="skp.aspx" enctype="multipart/form-data">
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#CCF2FF">
	<tr height="20px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
		</td>
	</tr>
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="100px"><b>TGL MEMO</b></td>            
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="120px"><b>NOMOR</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="205px"><b>KETUA</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="205px"><b>WAKIL KETUA</b></td>
...
<%
		If namaklpq.ToUpper() = "PNJ" AND levelaksesq > 1 Then
%>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM surat_kp WHERE (ID=" & idz(i) & ")"				
		myCmd.CommandText = SQL1
		myConn.Open()
		myReader = myCmd.ExecuteReader()
		...
		If myReader.HasRows Then
			While myReader.Read()
				...
				noskpxx = myReader("nomor").ToString()
				nourutxx = myReader("nourut").ToString()
				tglxx = myReader("tglskp").ToString()
				namaketuaxx = myReader("ketua").ToString()
				ketuajbtnxx = myReader("ketua_jbtn").ToString()
				namawakaxx = myReader("wakilketua").ToString()
				wakajbtnxx = myReader("wakilketua_jbtn").ToString()
				namaanggotaxx = myReader("anggota").ToString()
...
'================================================================================		
		...
		datastrxx = idxx & ",'" & noskpxx & "','" & tglsu & "','" & perihalxx & "','" & namaketuaxx & "','" & ketuajbtnxx & "','" & _
						namawakaxx & "','" & wakajbtnxx & "','" & namaanggotaxx & "','" & namafilexx & "','" & namafolderxx & _
...
%>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (noskpxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (namaketuaxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (namawakaxx) %></td>
...
<%
		'If namaklpq.ToUpper() = "PNJ" AND levelaksesq > 1 Then
		If Val(adaq)=1 AND levelaksesq > 1 Then
%>
		<td style="padding-left: 0px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top;">
			<!--a id="hapus<% Response.Write(i)%>" href="#" class="small button red" onclick="addkct(); return false;"><i class="fas fa-trash fa-sm"></i></a-->		
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/delete4.png" OnClick="hapusskp(<% Response.Write (idxx) %>);" height="26px" width="25px"/><br/>
		</td>
<%
		End If
%>
...
<form method="post" name="delfrm" id="delfrm" action="skpdelgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="delskpid" name="delskpid">
</form>

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delregvid") is nothing Then
		regvid = Request.Form("delregvid")
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM regvoucher WHERE (ID=" & regvid & ")"
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logregvoucherhapus (ID, nourut, tgl, tglinput, jenis, rubrik, tahun, klp, createduser, " & _
						"perihal, nominal, nomor, divisi, createddate, namafile, namafolder, undangan, tglhapus, userhapus) VALUES(" & _
						regvid & "," & nourutxx & ",'" & tglxx & "','" & cdatexx & "','" & jenisxx & "','" & rubrikxx & "'," & tahunxx & _
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM regvoucher WHERE ID=" & regvid

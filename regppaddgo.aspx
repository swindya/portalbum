...
'** Cek max value of nomor urut
			'SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [regpp] WHERE (rubrik='" & rubrik0 & "' AND tahun=" & tahun & ")"
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [regpp] WHERE (rubrik LIKE '%" & divstr & "%' AND tahun=" & tahun & ")"
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [regpp] WHERE (tahun=" & tahun & ")"
...
'=============================================================================================
			...
			SQL0 = "INSERT INTO regpp (nourut, tgl, tglinput, rubrik, tahun, klp, createduser," & _
					"perihal, nomor, nominal, divisi, createddate, namafile, namafolder) VALUES(" & maxu & ",'" & tgl0 & "','" & _
					tglinputq & "','" & rubrik0 & "'," & tahun & "," & klpq & "," & idq & ",'" & _
...
'response.write(SQL0)			
			...
			myConn.Close()
'=============================================================================================			
			SQL2 = "SELECT * FROM [regpp] WHERE nomor='" & nomorq & "'"
...
<meta http-equiv="refresh" content="0;url=regppprint.aspx?id=<% response.write(idku) %>" />
</body>
</html>
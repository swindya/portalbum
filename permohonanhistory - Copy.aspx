...
function viewpenunjukan(userid, adaid)
{
	...
	textfield2.id = "statusedit";
	textfield2.value = 2;
	document.getElementById('viewpenunjukanfrm').appendChild(textfield);
	document.getElementById('viewpenunjukanfrm').appendChild(textfield1);
	document.getElementById('viewpenunjukanfrm').appendChild(textfield2);
	document.forms["viewpenunjukanfrm"].submit();
}
</script>
			...
			<table style="text-align: left; margin-left: auto; margin-right: auto; margin-top: auto;" width="1200px" border="0" cellspacing="0" cellpadding="0">
				...
				<tr height="30px">
					...
					<td style="padding-left: 0px; text-align: left; font-size: 1.5em" width="1150px">
						<FONT face="Arial" color="#222"><b>KRONOLOGIS/HISTORICAL PENGADAAN</b></FONT>
					</td>
				</tr>
				<tr height="20px">
...
<table id="kpedittab" style="text-align: left; margin-left: 50px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="30px">
		...
		<td style="padding-left: 0px; text-align: left; font-family: Calibri; font-size: 1.1em; vertical-align: top" width="880px">
			<FONT face="Calibri" color="#000">
<% 
...
%>
	...
	<tr height="30px">
		...
		<td style="padding-left: 0px; text-align: left; font-size: 1.1em; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<!--input style="font-family: Calibri; font-size: 1.1em" type="text" id="datepicker-ex30" name="barupajaktglbayar" class="textboxtgl"-->
<%
...
%>
			...
			<img id="uploadPreview1" src="<% response.write("." & folderx & filesuratx) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & fileipx) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview3" src="<% response.write("." & folderx & filetorx) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview4" src="<% response.write("." & folderx & filerabx) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview1" src="<% response.write("." & folderx & file1x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & file2x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & file3x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & file4x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & file5x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
%>
			...
			<img id="uploadPreview2" src="<% response.write("." & folderx & file6x) %>" height="30px" width="25px"/><br/>
			</a>
<%
		Else
%>
...
'==============================================================================
	...
	If myReader.HasRows Then
		While myReader.Read()
			idx = myReader("ID").ToString()
			tglx = myReader("tgl").ToString()
			jmlprenegox = myReader("jmlprenego").ToString()
			jmlpostnegox = myReader("jmlpostnego").ToString()
...
%>
	<tr height="40px" style="background-color: #FFFFFF">
		<td style="padding-left: auto; text-align: center; font-size: 1.0em;">
			<FONT face="Calibri" color="#000">
				<a href="#" onclick="viewpenun(<% response.write(userid) %>,<% response.write(adaid) %>);">
				<% response.write(d) %>
				</a>
			</FONT>
		</td>
		...
		<td style="padding-left: 10px; text-align: left; font-size: 1.0em;">
			<FONT face="Calibri" color="#000">
<?php
				//echo number_format($jmlnilai5x,0);
?>			
			</FONT>
		</td>
		<td style="padding-left: auto; text-align: center; font-size: 1.0em;" width="50px">
...
%>
				Lama Waktu : &nbsp;&nbsp;<% response.write(days) %> &nbsp;hari
			</FONT>
		</td>
	</tr>

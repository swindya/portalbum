...
'** Cek max value of nomor urut
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [surat] WHERE (rubrik LIKE '%" & divstr & "%' AND jenis=" & jenis0 & _
					" AND tahun=" & tahun & ")"
...
'=========================================
			...
			SQL0 = "INSERT INTO surat (nourut, tglsurat, tglinput, jenis, rubrik, tahun, klp, createduser, tujuan," & _
...
'response.write(SQL0)			
			...
			myConn.Close()
'=========================================
			SQL2 = "SELECT * FROM [surat] WHERE (nourut=" & maxu & " AND jenis=" & jenis0 & " AND rubrik='" & pengirim0 & "')"
...
<meta http-equiv="refresh" content="0;url=suratprint.aspx?id=<% response.write(idku) %>" />
</body>
</html>
...
'=====================================================================================================================
			...
			If nomorke=2 Then
				SQL1 = "UPDATE pengadaan_spk SET nomor2='' WHERE ID=" & spkid
			Else If nomorke=3 Then
				SQL1 = "UPDATE pengadaan_spk SET nomor3='' WHERE ID=" & spkid
			Else If nomorke=4 Then
				SQL1 = "UPDATE pengadaan_spk SET nomor4='' WHERE ID=" & spkid
			Else If nomorke=5 Then
				SQL1 = "UPDATE pengadaan_spk SET nomor5='' WHERE ID=" & spkid
			Else If nomorke=6 Then
				SQL1 = "UPDATE pengadaan_spk SET nomor6='' WHERE ID=" & spkid
			End If

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("deladaid") is nothing Then
		adaid = Val(Request.Form("deladaid"))
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM pengadaan WHERE (ID=" & adaid & ")"
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM pengadaan WHERE ID=" & adaid

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("nkpid") is Nothing Then
		nkpid = Val(Request.Form("nkpid"))
	End If
...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaan_nkp] WHERE (ID=" & nkpid & ")"
...
'==================================================================================================================
			If dataexist=1 Then
				SQL0 = "UPDATE pengadaan_nkp SET tgl='" & tglx & "', keterangan='" & ket & "', namafolder='" & _
...
<meta http-equiv="refresh" content="0;url=prosesnkp.aspx?padaid=<% response.write(adaid) %>" />
</body>
</html>
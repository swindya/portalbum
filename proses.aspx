...
<script>
function vieweditdata(pid, userid, tahap, nok)
{

	if (tahap.toUpperCase()=="IJIN")
	{
		...
		textfield1.name = "pengadaanid";
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanmohonfrm').appendChild(textfield);
		document.getElementById('viewpengadaanmohonfrm').appendChild(textfield1);
		document.forms["viewpengadaanmohonfrm"].submit();
	}
	else if (tahap.toUpperCase()=="PROSES USULAN")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanusulfrm').appendChild(textfield);
		document.getElementById('viewpengadaanusulfrm').appendChild(textfield1);
		document.forms["viewpengadaanusulfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="AANWIJZING")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanaanfrm').appendChild(textfield);
		document.getElementById('viewpengadaanaanfrm').appendChild(textfield1);
		document.forms["viewpengadaanaanfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="POC")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanpocfrm').appendChild(textfield);
		document.getElementById('viewpengadaanpocfrm').appendChild(textfield1);
		document.forms["viewpengadaanpocfrm"].submit();			
	}
	else if (tahap.toUpperCase()=="EVALUASI")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanevalfrm').appendChild(textfield);
		document.getElementById('viewpengadaanevalfrm').appendChild(textfield1);
		document.forms["viewpengadaanevalfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="NEGOSIASI")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaannegofrm').appendChild(textfield);
		document.getElementById('viewpengadaannegofrm').appendChild(textfield1);
		document.forms["viewpengadaannegofrm"].submit();		
	}
	else if (tahap.toUpperCase()=="NKP")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaannkpfrm').appendChild(textfield);
		document.getElementById('viewpengadaannkpfrm').appendChild(textfield1);
		document.forms["viewpengadaannkpfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="SANGGAHAN")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaansanggahfrm').appendChild(textfield);
		document.getElementById('viewpengadaansanggahfrm').appendChild(textfield1);
		document.forms["viewpengadaansanggahfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="PENUNJUKAN")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaantunjukfrm').appendChild(textfield);
		document.getElementById('viewpengadaantunjukfrm').appendChild(textfield1);
		document.forms["viewpengadaantunjukfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="SPK")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanspkfrm').appendChild(textfield);
		document.getElementById('viewpengadaanspkfrm').appendChild(textfield1);
		document.forms["viewpengadaanspkfrm"].submit();		
	}
	else if (tahap.toUpperCase()=="PKS")
	{
		var textfield = document.createElement("input");
		textfield.type = "hidden";
		textfield.name = "userid";
		...
		textfield1.id = "pengadaanid";
		textfield1.value = pid;
		document.getElementById('viewpengadaanpksfrm').appendChild(textfield);
		document.getElementById('viewpengadaanpksfrm').appendChild(textfield1);
		document.forms["viewpengadaanpksfrm"].submit();		
	}

	//document.getElementsByName("adaid")[0].value = pid;
//alert(pid);
	//document.forms["viewpengadaanfrm"].submit();
}
</script>
...
<script>
function viewhistory(id, userid, stepku)
{
	document.getElementsByName("hisuserid")[0].value = userid;
	document.getElementsByName("hadaid")[0].value = id;
	document.forms["viewhistoryfrm"].submit();
}
</script>
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#000">PROSES PENGADAAN</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1160px" border="0" cellspacing="0" cellpadding="0" bgcolor="#E7FCFB">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				...
				<div>
					...
					<input style="padding-right: 10px; text-align: left; font-size: 1.0em; width: 500px; height: 18px;" type="text" id="namamohon" name="namamohon" class="textbox" value="<% Response.Write(namamohon) %>">
				</div>
			</FONT>
		</td>
	</tr>
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 220px; height: 26px" id="soflow1" name="tahapan" data-placeholder="Jenis" tabindex="2"> 
				<!--option value="" >&nbsp;&nbsp;</option-->
				<option value="0" 
<% 	If Val(tahap)=0 Then
...
<table id="mylist" style="margin-left: 270px;" width="1160px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="36px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="120px"><b>TGL</b></td>            
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="350px"><b>NAMA PENGADAAN</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="140px"><b>JML ANGGARAN</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="160px"><b>TAHAP</b></td>
<%
		If posisiq < 4 OR posisiq > 13 Then
%>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="100px"><b>VIEW/NEXT</b></td>
		<!--td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="80px"><b>HAPUS</b></td-->
<%
		Elseif posisiq > 3 Then
%>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="180px"><b>VIEW</b></td>
<%
		End If
%>		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="160px"><b>TIME LAPSE (HARI)</b></td>
...
'==========================================================================
	...
	SQL2 = "SELECT ID FROM pengadaan WHERE (step<>'IJIN'" & namastr & tglstr & tahapstr & klpstr & divstr & ") ORDER BY tglmohon DESC"
			...
			for i = startval to endval
				...
				If myReader.HasRows Then
					While myReader.Read()
						...
						tglstepx = myReader("tglstep").ToString()
				...
				If stepx.ToUpper()="PKS" Then
					SQL4 = "SELECT * FROM pengadaan_spk WHERE pengadaanID=" & idz(c)
					myCmd.CommandText = SQL4
					myConn.Open()
					myReader = myCmd.ExecuteReader()
					If myReader.HasRows Then
						While myReader.Read()
							tglspkx = myReader("tgl").ToString()					
						End While
					End If
					myConn.Close()					
				End If
				...
				datastrx = idx & "," & cuserx & ",'" & stepx & "'"
%>

	<tr id="row<% Response.Write(bb)%>" height="30px">
		<td style="padding-right: 5px; padding-top: 3px; font-family: Arial; text-align: right; vertical-align: top;">
			<a id="e00<% Response.Write (i)%>" style="font-family: Arial; font-size: 0.9em;text-decoration: none;" class="underline" href="#" onclick="viewhistory(<% Response.Write(datastrx) %>);">
			<% Response.Write (i) %>
			</a>
		</td>
		<td style="padding-left: 5px; padding-top: 3px; font-family: Arial; text-align: center; vertical-align: top;">
			<a id="f11<% Response.Write (i)%>" style="font-family: Arial; font-size: 0.9em;text-decoration: none;" class="underline" href="#" onclick="viewhistory(<% Response.Write(datastrx) %>);">
			<% Response.Write (tglsu) %>
			</a>
		</td>
		<td style="padding-left: 5px; padding-top: 3px; text-align: left; vertical-align: top;">
			<a id="g22<% Response.Write (i)%>" style="font-family: Arial; font-size: 0.9em;text-decoration: none;" class="underline" href="#" onclick="viewhistory(<% Response.Write(datastrx) %>);">
...
%>
		<td style="padding-left: 0px; padding-top: 3px; font-family: Arial; font-size: 0.9em;text-align: center; color: #000; background-color: #FFF; vertical-align: top;">
<%
	End If
%>
			<% Response.Write (stepstr) %>
		</td>
		<td style="padding-left: 0px; padding-top: 0px; font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top;">
			<!--a id="edit<% Response.Write (i)%>" href="" class="small button blue" onclick="addkct(); return false;"><i class="fas fa-edit fa-sm"></i></a-->
			<a id="edit<% Response.Write (i)%>" href="#" onclick="vieweditdata(<% Response.Write(datastrx) %>,1);">
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/next2.jpg" height="26px" width="25px"/><br/>
			</a>
		</td>

		<td style="padding-left: 0px; padding-top: 3px; font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top;">
<%
...
%>
			...
			<!--img id="uploadPreview<% Response.Write (i)%>" src="./images/next2.jpg" OnClick="hapuskct(<% Response.Write (idx) %>);" height="26px" width="25px"/><br/-->
<%
		End If
		If tglstepx is nothing OR tglstepx.length() < 1 Then
			tglstepx = strDate
		End If
		If stepx.ToUpper()="PKS" Then
			tglstepx = tglspkx
		End If
		If Not tglx is nothing AND Not tglstepx is nothing Then
			days = DateDiff("d", Convert.ToDateTime(tglx), Convert.ToDateTime(tglstepx))
		End If
		response.write(days)
%>
		</td>
...
<form name="pagefrm" id="pagefrm" method="post" action="main.aspx" enctype="multipart/form-data">
	<input type="hidden" id="muserid" name="muserid" value="<% response.write(idq) %>">
...
<form name="viewhistoryfrm" id="viewhistoryfrm" method="post" action="permohonanhistory.aspx" target="_blank" enctype="multipart/form-data">
	<input type="hidden" id="hisuserid" name="hisuserid">
	<input type="hidden" id="hadaid" name="hadaid">
</form>
...
<form name="viewpengadaanmohonfrm" id="viewpengadaanmohonfrm" action="vpengadaanmohon.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanusulfrm" id="viewpengadaanusulfrm" action="prosesusulan.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanaanfrm" id="viewpengadaanaanfrm" action="prosesaanwijzing.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanpocfrm" id="viewpengadaanpocfrm" action="prosespoc.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanevalfrm" id="viewpengadaanevalfrm" action="prosesevaluasi.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaannegofrm" id="viewpengadaannegofrm" action="prosesnegosiasi.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaannkpfrm" id="viewpengadaannkpfrm" action="prosesnkp.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaansanggahfrm" id="viewpengadaansanggahfrm" action="prosessanggah.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaantunjukfrm" id="viewpengadaantunjukfrm" action="prosespenunjukan.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanspkfrm" id="viewpengadaanspkfrm" action="prosesspk.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaanpksfrm" id="viewpengadaanpksfrm" action="prosespks.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>

<form name="viewpengadaansppfrm" id="viewpengadaansppfrm" action="vpengadaanspp.aspx" method="post" target="_blank" enctype="multipart/form-data">
</form>



<form name="viewpengadaanviewfrm" id="viewpengadaanviewfrm" action="vpengadaanhistory.php" method="post" target="_blank" enctype="multipart/form-data">
</form>

...
<%	
    'Using workBook As New XLWorkbook(FileUpload1.PostedFile.InputStream)
			...
			If NOT Request.Form("notinsql") is Nothing Then
				SQLex = Request.Form("notinsql")
			End If
        ...
        'Read the first Sheet from Excel file.
			...
			namafile0 = folder1 & "notinOUT.xls"
			namafileout = folder1 & "notinOUT.xls"
...
'==============================================================================================
			...
			SQL0 = "CREATE TABLE Sheet1 ([NO] INTEGER, [NOMOR] TEXT(200), [NOURUT] INT, [TGL] DATE," & _
...
'response.write(SQLex & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					tglxx(a) = myReader("tglnotin").ToString()
...
'response.write(jmlsurat & "<br>")
			For a = 1 to jmlsurat
				connExcelw.Open()
				cmdExcelw.Connection = connExcelw
				sqlout = "INSERT INTO [Sheet1$] ([NO], [NOMOR], [NOURUT], [TGL], [PERIHAL], [TUJUAN], [TEMBUSAN], [UNDANGAN], [KELOMPOK]) " & _
						"VALUES(" & a & ",'" & nosuratxx(a) & "'," & nourutxx(a) & ",'" & tglx(a) & "','" & perihalxx(a) & "','" & _
...
<%
	namafileout = "./DOC/surat/Temp/notinOUT.xls"
%>

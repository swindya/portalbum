...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delrpid") is nothing Then
		regppid = Request.Form("delrpid")
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM regpp WHERE (ID=" & regppid & ")"
'response.write(SQL1 & "<br>")					
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					nominalxx = myReader("nominal").ToString()
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logregpphapus (hapusID, nourut, tgl, jenis, rubrik, tahun, klp, createduser, " & _
						"perihal, nominal, nomor, divisi, createddate, namafile, namafolder, tglhapus, userhapus) VALUES(" & _
						regppid & "," & nourutxx & ",'" & tglxx & "','" & jenisxx & "','" & rubrikxx & "'," & tahunxx & _
						"," & klpxx & "," & cuserxx & ",'" & perihalxx & "'," & nominalxx & ",'" & _
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM regpp WHERE ID=" & regppid
...
<meta http-equiv="refresh" content="0;url=regpp.aspx" />
</body>
</html>
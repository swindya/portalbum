...
'=========================================
			SQL0 = "UPDATE pengadaan  SET tglmohon='" & tgl0 & "', nama='" & nama0.toUpper() & "', jenispengadaan='" & jenis0.toUpper() & _
					"', jenisanggaran='" & jenisanggaran0.toUpper() &	"', namafolder='" & folder2 & "', namafilesurat='" & _
					nfsurat & "', namafileip='" & nfip & "', namafiletor='" & nftor & "', namafilerab='" & _
					nfrab & "' WHERE ID=" & mohonid
'response.write(SQL0)			
...
<meta http-equiv="refresh" content="0;url=permohonanedit.aspx" />
</body>
</html>
...
'Waktu -> prefix namafile
	...
	'folder1 = "~/portalbum/DOC/memo/" & tahun & "/" & bulan & "/"
...
'** Cek max value of nomor urut
			...
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [memo] WHERE (rubrik LIKE '%" & divstr & "%' AND jenis=" & jenis0 & _
					" AND tahun=" & tahun & ")"
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [memo] WHERE (jenis=" & jenis0 & _
					" AND tahun=" & tahun & ")"
...
'=========================================
			...
			SQL0 = "INSERT INTO memo (nourut, tglmemo, tglinput, jenis, rubrik, tahun, klp, createduser, tujuan," & _
					"perihal, cc, nomor, jam, divisi, createddate, namafile, namafolder, undangan) VALUES(" & maxu & ",'" & tgl0 & "','" & _
					tglinputq & "'," & jenis0 & ",'" & pengirim0 & "'," & tahun & "," & klpq & "," & idq & ",'" & tujuan0.ToUpper() & _
					"','" & perihal0.ToUpper() & "','" & tembusan0.ToUpper() & "','" & nomorq & "','" & jamsaiki & "'," & divq & ",'" & 
					tglinputq & "','" & namafilexx & "','" & namafolderx & "'," & jenisund0 & ")"
					'kcx.ToUpper() & "',1)"
'response.write(SQL0)			
			...
			myConn.Close()
'=========================================
			SQL2 = "SELECT * FROM [memo] WHERE (nourut=" & maxu & " AND jenis=" & jenis0 & " AND rubrik='" & pengirim0 & "')"
...
<meta http-equiv="refresh" content="0;url=memoprint.aspx?id=<% response.write(idku) %>" />
</body>
</html>
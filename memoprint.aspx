...
<%			
			...
			If NOT Request.QueryString("id") is Nothing Then
				 suratid = Val(Request.QueryString("id"))
			End If
...
<%
			...
			SQL1 = "SELECT * FROM [memo] WHERE ID=" & suratid	
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">MEMO</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="1050px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top" width="700px">
			<FONT face="Arial" color="#000">
<%
				response.write(tglku)
%>
			</FONT>
		</td>
...
<%
				If jenisxx="1" Then
					response.write("Biasa")
				Else If jenisxx = "2" Then
					response.write("Rahasia")
				End If
%>		
			</FONT>
		</td>
...
%>			
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; font-weight: 600; font-size: 1.2em; vertical-align: top">
...
<% 
		If jenisundanganxx=1 Then
%>
			<img id="abc" src="./images/checkme.png" height="20px" width="20px"/>
<%
		Else
%>
			<img id="abc" src="./images/exit.png" height="20px" width="20px"/>
<%
		End If
%> 
...
<form method="post" name="memobarufrm" id="memobarufrm" action="memo.aspx" enctype="multipart/form-data">

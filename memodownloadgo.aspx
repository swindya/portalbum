...
<%	
    'Using workBook As New XLWorkbook(FileUpload1.PostedFile.InputStream)
			...
			If NOT Request.Form("memosql") is Nothing Then
				SQLex = Request.Form("memosql")
			End If
        ...
        'Read the first Sheet from Excel file.
			...
			namafile0 = folder1 & "memoOUT.xls"
			namafileout = folder1 & "memoOUT.xls"
...
'response.write(SQLex & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					tglxx(a) = myReader("tglmemo").ToString()
...
<%
	namafileout = "./DOC/surat/Temp/memoOUT.xls"
%>

...
'==============================================================================
			SQL3 = "SELECT * FROM pengadaan_penunjukan WHERE ID=" & tunid
...
'=====================================================================================================================
				...
				myConn.Close()
'=====================================================================================================================
' Update nomor pada pengadaan penunjukan
'=====================================================================================================================
				'SQL3 = "UPDATE pengadaan_penunjukan SET nomor='" & nomorq & "' WHERE ID=" & tunid
				
				If a=0 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor='" & nomorq & "' WHERE ID=" & tunid
				Else If a=1 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor2='" & nomorq & "' WHERE ID=" & tunid
				Else If a=2 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor3='" & nomorq & "' WHERE ID=" & tunid
				Else If a=3 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor4='" & nomorq & "' WHERE ID=" & tunid
				Else If a=4 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor5='" & nomorq & "' WHERE ID=" & tunid
				Else If a=5 Then
					SQL3 = "UPDATE pengadaan_penunjukan SET nomor6='" & nomorq & "' WHERE ID=" & tunid
				End If				

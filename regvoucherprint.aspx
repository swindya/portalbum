...
function databaru()
{
	document.forms["regvoubarufrm"].submit();
}
</script>
...
<%			
			If NOT Request.QueryString("id") is Nothing Then
				 id0 = Val(Request.QueryString("id"))
			End If
...
' Data Reg Voucher
'============================================================================
			SQL0 = "SELECT * FROM [regvoucher] WHERE ID=" & id0
'response.write(SQL0 & "<br>")
            ...
            If myReader.HasRows Then
                While myReader.Read()
					...
					If jenisxx.ToUpper() = "DI" OR jenisxx.ToUpper() = "DEBET INTERN" Then
						jenisxxx = "DEBET INTERN"
					Else If jenisxx.ToUpper() = "NK" OR jenisxx.ToUpper() = "NOTA KREDIT" Then
						jenisxxx = "NOTA KREDIT"
					Else If jenisxx.ToUpper() = "ND" OR jenisxx.ToUpper()="NOTA DEBET" Then
						jenisxxx = "NOTA DEBET"
					End If
					...
					If tglxx.length() > 5 Then
						...
						tgl10 = tglarr(0)
						tglarr = tgl10.Split("/")
						tgl10 = tglarr(0) & "-" & tglarr(1) & "-" & tglarr(2)
					End If
'response.write(nosuratxx & "<br>")
				End While
			End If
			myConn.Close()
...
'response.write(folderfilexx & "<br>")
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="990px" border="0" cellspacing="0" cellpadding="0">
	<tr height="0px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
		</td>
	</tr>
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#045CFF">DATA BARU</FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle" width="570px">
			<FONT face="Arial" color="#000">
<%
				response.write(tgl10)
%>
			</FONT>
		</td>
...
<%
	If perihalxx.length() < 70 Then
%>
	<tr height="38px">
<%
	Else If perihalxx.length() > 69 Then
%>
	<tr height="65px">
<%
	End If
%>
		<td style="padding-top: 10px; padding-left: 0px; text-align: left; font-size: 0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				Perihal
			</FONT>			
		</td>
		<td style="padding-top: 10px; padding-left: 0px; text-align: center; font-size: 1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-top: 10px; padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
<%
				response.write(perihalxx)
%>	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
...
%>	
	...
	<tr height="35px">
		...
		<td style="padding-top: 0px; padding-left: 0px; text-align: left; vertical-align: middle; font-size: 1.2em;">
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
<%
				response.write("Rp. " & nominalxx.ToString("#,###"))
%>
			</FONT>
			...
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					...
					<td style="padding-top: 5px; padding-left: auto; text-align: right; font-size: 1.2em" width="40px">
						<FONT face="Arial" color="#000">
<%
						'If Not folderfilexx is nothing AND folderfilexx.length() > 3 Then
						If statusx = 1 Then
%>
...
<form method="post" name="regvoubarufrm" id="regvoubarufrm" action="regvoucher.aspx" enctype="multipart/form-data">

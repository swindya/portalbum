...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delmemoid") is nothing Then
		memoid = Request.Form("delmemoid")
	End If
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logmemohapus (memoID, nourut, tglmemo, tglinput, jenis, rubrik, tahun, klp, createduser, tujuan," & _
						"perihal, cc, nomor, divisi, createddate, namafile, namafolder, undangan, tglhapus, userhapus) VALUES(" & _
						memoid & "," & nourutxx & ",'" & tglxx & "','" & tglinputxx & "'," & jenisxx & ",'" & rubrikxx & "'," & tahunxx & _
						"," & klpxx & "," & cuserxx & ",'" & tujuanxx & "','" & perihalxx & "','" & tembusanxx & "','" & _
						nomemoxx & "'," & divisixx & ",'" & cdatexx & "','" & namafilexx & "','" & namafolderxx & "'," & _
...
'response.write(SQL0)
				...
				SQLdel = "DELETE FROM memo WHERE ID=" & memoid

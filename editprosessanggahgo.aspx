...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("sanggahid") is Nothing Then
...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaan_sanggah] WHERE (ID=" & nkpid & ")"
...
'==================================================================================================================
			If dataexist=1 Then
				SQL0 = "UPDATE pengadaan_sanggah SET tgl='" & tglx & "', keterangan='" & ket & "', namafolder='" & _
...
<meta http-equiv="refresh" content="0;url=prosessanggah.aspx?padaid=<% response.write(adaid) %>&statusnext=<% response.write(statusnextx) %>" />
</body>
</html>
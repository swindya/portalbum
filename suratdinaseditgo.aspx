...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("editsuratid") is nothing Then
		suratid = Request.Form("editsuratid")
	End If
	...
	jenissu = jenis0.ToUpper()
	
'response.write(jenis0)	
...
'Waktu -> prefix namafile
	...
	folder1 = "./DOC/suratdinas/" & tahun & "/" & bulan & "/" & harin & "/"
	...
	Dim namafolderx as String = "/DOC/suratdinas/" & tahun & "/" & bulan & "/" & harin & "/"
...
'=========================================
			...
			If statusfile=0 Then
				SQL0 = "UPDATE suratdinas SET tujuan='" & tujuan0.ToUpper() & "', perihal='" & _
						perihal0.ToUpper() & "', cc='" & tembusan0.ToUpper() & "' WHERE (ID=" & suratid & ")"
			ElseIf statusfile=1 Then
				SQL0 = "UPDATE suratdinas SET tujuan='" & tujuan0.ToUpper() & "', perihal='" & _
						perihal0.ToUpper() & "', cc='" & tembusan0.ToUpper() & "', namafile='" & namafilexx & _
						"', namafolder='" & namafolderx & "' WHERE (ID=" & suratid & ")"
			End If

'kcx.ToUpper() & "',1)"
'response.write(jenissu & "<br>")			

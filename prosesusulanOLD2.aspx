...
%>><% Response.Write(tahunsesuk)%></option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 170px" id="soflow22" name="editjenis" data-placeholder="Jenis" tabindex="3"> 
				<option value="">&nbsp;&nbsp;</option>
...
%>>DESENTRALISASI</option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 150px" id="soflow23" name="editjenisanggaran" data-placeholder="Jenis" tabindex="5"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="opex" 
<% 
...
%>>CAPEX</option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-right: 10px; font-size: 1.0em; text-align: right; width: 135px; height: 20px;" type="text" id="editnom" name="editnom" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(nilaixx.ToString("#,###")) %>" tabindex="6">
			</FONT>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-right: 10px; font-size: 1.0em; text-align: right; width: 135px; height: 20px;" type="text" id="edithps" name="edithps" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(nilaihpsxx.ToString("#,###")) %>" tabindex="7">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:1.0em; vertical-align: top">
			<FONT color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editketerangan" name="editketerangan" tabindex="8"><% response.write(ketx) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<%
		if statusverok = 1 AND statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none;" onclick="gotoaanwijzing();"><FONT face="Arial" color="#000">Proses Aanwijzing</FONT></a>
<%
		End If
%>
		</td>

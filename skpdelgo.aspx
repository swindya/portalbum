...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delskpid") is nothing Then
		suratid = Request.Form("delskpid")
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM [surat_kp] WHERE (ID=" & suratid & ")"
'response.write(SQL1 & "<br>")					
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					divisixx = Val(myReader("divisi").ToString())
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logskphapus (skpID, nourut, ketua, ketuajab, wakilketua, wakilketuajab, tahun, klp, createduser," & _
						"anggota, perihal, nomor, divisi, createddate, namafile, namafolder, tglhapus, userhapus) VALUES(" & _
						suratid & "," & nourutxx & ",'" & namaketuaxx & "','" & ketuajbtnxx & "','" & namawakaxx & "','" & wakajbtnxx & "'," & tahunxx & _
						"," & klpxx & "," & cuserxx & ",'" & namaanggotaxx & "','" & perihalxx & "','" & _
						noskpxx & "'," & divisixx & ",'" & cdatexx & "','" & namafilexx & "','" & namafolderxx & "','" & _
						tglsaiki & "'," & user0 & ")"
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM surat_kp WHERE ID=" & suratid

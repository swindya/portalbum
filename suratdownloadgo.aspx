...
<%
	...
	Dim nourutxx(100000) as String
	Dim undanganxx(100000) as String
...
<%	
    'Using workBook As New XLWorkbook(FileUpload1.PostedFile.InputStream)
			...
			If NOT Request.Form("suratsql") is Nothing Then
				SQLex = Request.Form("suratsql")
			End If
        ...
        'Read the first Sheet from Excel file.
			...
			namafile0 = folder1 & "suratOUT.xls"
			namafileout = folder1 & "suratOUT.xls"
...
'==============================================================================================
			...
			SQL0 = "CREATE TABLE Sheet1 ([NO] INTEGER, [NOMOR] TEXT(200), [NOURUT] INT, [TGL] DATE, [JENIS] TEXT(200)," & _
								"[PERIHAL] TEXT(200),[TUJUAN] TEXT(200)," & _
								"[TEMBUSAN] TEXT(200), [UNDANGAN] INT, [KELOMPOK] TEXT(200))"
...
'response.write(SQLex & "<br>")
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					tglxx(a) = myReader("tglsurat").ToString()
					jenisxx(a) = Val(myReader("jenis").ToString())
					If jenisxx(a)=1 Then
						jenisstrxx(a) = "BIASA"
					Else If jenisxx(a)=2 Then
						jenisstrxx(a) = "RAHASIA"
					End If
					klpxx(a) = Val(myReader("klp").ToString())
					rubrikxx(a) = myReader("rubrik").ToString()
					perihalxx(a) = myReader("perihal").ToString()
					tujuanxx(a) = myReader("tujuan").ToString()
					tembusanxx(a) = myReader("cc").ToString()
					jenisundanganxx(a) = myReader("undangan").ToString()
...
'response.write(jmlsurat & "<br>")
			For a = 1 to jmlsurat
				connExcelw.Open()
				cmdExcelw.Connection = connExcelw
				sqlout = "INSERT INTO [Sheet1$] ([NO], [NOMOR], [NOURUT], [TGL], [JENIS], [PERIHAL], [TUJUAN], [TEMBUSAN], [UNDANGAN], [KELOMPOK]) " & _
						"VALUES(" & a & ",'" & nosuratxx(a) & "'," & nourutxx(a) & ",'" & tglx(a) & "','" & jenisstrxx(a) & "','" & perihalxx(a) & "','" & _
						tujuanxx(a) & "','" & tembusanxx(a) & "'," & jenisundanganxx(a) & ",'" & namaklpxx(a) & "')"
...
<%
	namafileout = "./DOC/surat/Temp/suratOUT.xls"
%>

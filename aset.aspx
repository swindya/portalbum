...
<%
	...
	Dim ruanganxx as String
	Dim merkxx as String
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If perihal.length()>0 Then
				perihalstr = " AND (nomor LIKE '%" & perihal & "%' OR nama LIKE '%" & perihal & "%')"
			End If
...
' Data MEMO
'============================================================================
			SQL00 = "SELECT ID FROM aset WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
			If namaklpq.ToUpper() = "BUM" Then
				SQL00 = "SELECT ID FROM [aset] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
			End If
			SQLexport = "SELECT * FROM [aset] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 200px; height: 18px" type="text" id="barukode" name="barukode" class="textbox" onchange="getnama(this.value);" tabindex="2">
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 50px; height: 18px" type="text" id="baruqty" name="baruqty" class="textbox" onchange="getnama(this.value);" tabindex="3">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 500px; height: 18px" type="text" id="barunama" name="barunama" class="textbox" onchange="getnama(this.value);" tabindex="4">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 500px; height: 18px" type="text" id="barumerk" name="barumerk" class="textbox" onchange="getnama(this.value);" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-size: 0.9em; width: 240px; height: 18px" type="text" id="barunilai" name="barunilai" class="textbox" tabindex="6">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="130px"><b>TGL PEROLEHAN</b></td>            
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="130px"><b>NOMOR/KODE</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="235px"><b>NAMA ASET</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="235px"><b>MERK</b></td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="210px"><b>RUANGAN</b></td>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM aset WHERE (ID=" & idz(i) & ")"
		...
		If myReader.HasRows Then
			While myReader.Read()
				...
				namaxx = myReader("nama").ToString()
				ruanganxx = myReader("ruangan").ToString()
				merkxx = myReader("merk").ToString()
...
'================================================================================		
		...
		datastrxx = idxx & ",'" & nomorxx & "','" & tglsu & "'," & namaxx & ",'" & merkxx & "','" & ruanganxx & "','" & _
...
%>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (nomorxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (namaxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (merkxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (ruanganxx.ToUpper()) %></td>

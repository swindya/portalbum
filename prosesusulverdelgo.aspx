...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("uadaid") is nothing Then
		adaid = Val(Request.Form("uadaid"))
	End If
...
'=============================================================================================
			SQL1 = "SELECT * FROM pengadaanusulverifikasi WHERE (ID=" & verid & ")"
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM pengadaanusulverifikasi WHERE ID=" & verid
...
<meta http-equiv="refresh" content="0;url=prosesusulan.aspx?padaid=<% response.write(adaid) %>" />
</body>
</html>
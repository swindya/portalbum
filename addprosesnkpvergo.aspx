...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaannkpverifikasi] WHERE (pengadaanID=" & mohonid & " AND jenis='" & jenisver & "') ORDER BY nourut ASC"
...
'==================================================================================================================
			SQL0 = "INSERT INTO pengadaannkpverifikasi (pengadaanID, tgl, jenis, status, nourut, keterangan, createduser, createddatetime) VALUES(" & _
...
<meta http-equiv="refresh" content="0;url=prosesnkp.aspx?padaid=<% response.write(mohonid) %>" />
</body>
</html>
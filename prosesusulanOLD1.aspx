...
function saveverifikasi()
{
	...
	document.getElementsByName("vernourut")[0].value = document.getElementById("barunourut").value;
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="700px">
			<FONT face="Arial" color="#000">
				...
				<input autocomplete="off" STYLE="padding-left:5px; font-size:1.0em; border:1px solid #ababab; height: 24px; width: 120px" autocomplete="off" class="tcal" id="edittgl" name="edittgl" type="text" value="<% response.write(tglxx) %>" tabindex="1">
			</FONT>
		</td>
...
%>><% Response.Write(tahunsesuk)%></option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 150px" id="soflow22" name="editjenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="">&nbsp;&nbsp;</option>
...
%>>Desentralisasi</option>
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:1.0em; vertical-align: top">
			<FONT color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editnama" name="editnama" rows="3" cols="81" tabindex="3" disabled><% response.write(namax) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
%>>CAPEX</option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-right: 10px; font-size: 1.0em; text-align: right; width: 135px; height: 20px;" type="text" id="editnom" name="editnom" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(nilaijml.ToString("#,###")) %>" tabindex="4" disabled>
			</FONT>
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:1.0em; vertical-align: top">
			<FONT color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editketerangan" name="editketerangan" tabindex="3"><% response.write(ketx) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table bordercolor="#999999" style="text-align: left; margin-left: 300px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
	<tr height="32px" style="background-color: #FFFFFF">
		<td style="padding-left: auto; text-align: left; font-size: 0.9em;" width="200px">
<%
			If statusrejectx=0 Then
%>
			<FONT face="Arial" color="#000">
			<a id="addverbtn" href="#" class="medium button green" onclick="viewnewver();"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Proses</a>
			</FONT>
<%
			End If
%>
...
<table id="verifikasiheadertab" bordercolor="#FFFFFF" style="text-align: left; margin-left: 300px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
	<tr height="35px" style="background-color: #FFD5B0">
		...
		<td style="padding-left: auto; text-align: center; font-size: 0.9em;" width="150px">
			<FONT face="Arial" color="#000"><b>JENIS AKTIVITAS</b></FONT>
		</td>
		<td style="padding-left: auto; text-align: center; font-size: 0.9em;" width="80px">
			<FONT face="Arial" color="#000"><b>KE</b></FONT>
		</td>
		<td style="padding-left: auto; text-align: center; font-size: 0.9em;" width="130px">
			<FONT face="Arial" color="#000"><b>TGL</b></FONT>
		</td>
		<td style="padding-left: auto; text-align: center; font-size: 0.9em;" width="270px">
...
%>
	<tr height="27px" style="background-color: #FFFFFF">
		<td style="padding-left: auto; text-align: center; font-size: 0.9em;" width="50px">
		...
		<td style="padding-left: 10px; text-align: left; font-size: 0.9em;" width="150px">
			<FONT face="Arial" color="#000">
<% 
...
%>
		...
		<td style="padding-left: auto; font-size: 0.9em; text-align: center;" width="80px">
			<FONT face="Arial" color="#000">
<% 
				response.write(nourutxx(b))
%>			</FONT>
		</td>
		<td style="padding-left: 10px; font-size: 0.9em; text-align: left;" width="120px">
			<FONT face="Arial" color="#000">
<%
...
%>
		...
		<td style="padding-left: 10px; font-size: 0.9em; text-align: left;" width="270px">
			<FONT face="Arial" color="#000">
<%
...
<table id="newverifikasitab" bordercolor="#FFFFFF" style="text-align: left; display:none; margin-left: 350px; margin-right: auto; margin-top: 0;" border="0" cellspacing="0" cellpadding="0">
	<tr height="40px" style="background-color: #FFFFFF">
		<td style="padding-left: 5px; text-align: center;" width="150px">
			<FONT face="Arial" color="#000">
				<input type="hidden" id="newuserid" name="newuserid">
				<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; height: 28px; width: 140px" id="barujenisver" name="barujenisver" data-placeholder="Jenis" tabindex="1"> 
					<option value="" >&nbsp;&nbsp;</option>
		...
		<td style="padding-left: auto; text-align: center;" width="80px">
			<input style="font-family: Arial; font-size: 1.0em; width: 65px; height: 20px;" type="text" id="barunourut" name="barunourut" class="textbox" tabindex="4" readonly>
		</td>
		<td style="padding-left: auto; text-align: center;" width="130px">
			<FONT face="Arial" color="#000">
				<input autocomplete="off" STYLE="padding-left:3px; font-size:1.0em; border:1px solid #ababab; height: 24px; width: 105px" autocomplete="off" class="tcal" id="barutgl" name="barutgl" type="text" tabindex="1">	
			</FONT>	
		</td>
		<td style="padding-left: auto; text-align: center;" width="270px">
			<input style="font-family: Arial; text-align: left; font-size: 1.0em; height: 20px; width: 250px" type="text" id="baruket" name="baruket" class="textbox" tabindex="4">
		</td>
		<td style="padding-left: 20px; text-align: center; font-size: 1.2em" width="120px">
			<FONT face="Arial" color="#000">
				<a href="#" class="small button green" onClick="saveverifikasi();"><i class="fas fa-save" aria-hidden="true"></i>&nbsp;&nbsp;Simpan</a>
			</FONT>
		</td>
...
<%
		If statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none;" onclick="gotoaanwijzing();"><FONT face="Arial" color="#000">Aanwijzing</FONT></a>
<%
		End If
%>
		</td>

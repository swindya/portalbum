...
'=====================================================================================================================
			...
			If nomorke=2 Then
				SQL1 = "UPDATE pengadaan_penunjukan SET nomor2='' WHERE ID=" & tunid
			Else If nomorke=3 Then
				SQL1 = "UPDATE pengadaan_penunjukan SET nomor3='' WHERE ID=" & tunid
			Else If nomorke=4 Then
				SQL1 = "UPDATE pengadaan_penunjukan SET nomor4='' WHERE ID=" & tunid
			Else If nomorke=5 Then
				SQL1 = "UPDATE pengadaan_penunjukan SET nomor5='' WHERE ID=" & tunid
			Else If nomorke=6 Then
				SQL1 = "UPDATE pengadaan_penunjukan SET nomor6='' WHERE ID=" & tunid
			End If

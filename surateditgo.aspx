...
'=========================================
			...
			If statusfile=0 Then
				SQL0 = "UPDATE surat SET tglsurat='" & tgl0 & "',tglinput='" & tglinputq & _
						"', tahun=" & tahun & ", klp=" & klpq & ", createduser=" & idq & _
						", tujuan='" & tujuan0.ToUpper() & "', perihal='" & perihal0.ToUpper() & "', cc='" & tembusan0.ToUpper() & _
						"', jam='" & jamsaiki & "', divisi=" & divq & ", createddate='" & tglinputq & _
						"', undangan=" & jenisund0 & ", nomor='" & pengirim0 & nourut & "' WHERE (ID=" & suratid & ")"

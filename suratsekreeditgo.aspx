...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("editdari") is nothing Then
		dari0 = Request.Form("editdari")
	End If
	...
	If NOT Request.Form("edittglsurat") is nothing Then
		tglsurat0 = Request.Form("edittglsurat")
...
'=========================================
			...
			If statusfile=0 Then
				SQL0 = "UPDATE [surat_sekretaris] SET tglsurat='" & tgl0 & "', jenisstr='" & jenis0 & _
						"', tahun=" & tahun & ", tujuan='" & tujuan0.ToUpper() & "', perihal='" & perihal0.ToUpper() & _
						"', cc='" & tembusan0.ToUpper() & "', nomor='" & nomor0 & "' WHERE (ID=" & suratid & ")"
			ElseIf statusfile=1 Then
				SQL0 = "UPDATE [surat_sekretaris] SET tglsurat='" & tgl0 & "',jenisstr='" & jenis0 & _
						"', tahun=" & tahun & ", tujuan='" & tujuan0.ToUpper() & "', perihal='" & perihal0.ToUpper() & _
						"', cc='" & tembusan0.ToUpper() & "', nomor='" & nomor0 & _
						"', namafile='" & namafilexx & "', namafolder='" & namafolderx & "' WHERE (ID=" & suratid & ")"
			End If

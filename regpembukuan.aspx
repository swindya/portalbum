...
<script>
function editdatax(id, nosurat, tgl, jenis, perihal, rubrik, tujuan, tembusan, jenisundangan, namafile, namafolder, extens)
{
...
%>
<script>
alert('Anda tidak beraktivitas terlalu lama (idle) atau sesi anda habis. Silahkan signin lagi');
...
' Data SURAT
'============================================================================
			SQL0 = "SELECT ID FROM [surat] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglsurat DESC"
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#000"><b>DAFTAR REGISTRASI PEMBUKUAN</b></FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<table id="databarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="35px">
		<td style="padding-left: 0px; text-align: left; font-size: 0.9em; vertical-align: top">
			...
			<FONT face="Calibri" color="#DD0000">
				* 
			</FONT>				
		</td>
...
$('#calendar-demo').dcalendar(); //creates the calendar
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<textarea STYLE="padding-top: 5px; padding-bottom:5px; color: #000000; font-family: Calibri; padding-left: 5px; border:1px solid #ababab; font-weight: normal; font-size:1.0em; line-height: 110%;" id="baruperihal" name="baruperihal" rows="2" cols="88" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 130px" id="soflow12" name="barupengirim" data-placeholder="Jenis" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 640px" type="text" id="barutujuan" name="barutujuan" class="textbox" onchange="getnama(this.value);" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 640px" type="text" id="barutembusan" name="barutembusan" class="textbox" onchange="getnama(this.value);" tabindex="6">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	<tr height="0px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
		</td>
	</tr>
...
$('#calendar-demo').dcalendar(); //creates the calendar
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow21" name="editjenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="1" >Biasa</option>
				<option value="2" >Rahasia</option>
			</select>			
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<textarea STYLE="color: #000000; font-family: Calibri; padding-left: 5px; border:1px solid #ababab; font-weight: normal; font-size:1.0em; line-height: 110%;" id="editperihal" name="editperihal" rows="3" cols="81" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<!--input style="font-family: Calibri; font-size: 1.0em; width: 560px" type="text" id="editpengirim" name="editpengirim" class="textbox" onchange="getnama(this.value);" tabindex="4"-->
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow22" name="editpengirim" data-placeholder="Pengirim" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
			for b=1 to jmlrubrik
%>
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 150px" type="text" id="editnomor" name="editnomor" class="textbox" onchange="getnama(this.value);" tabindex="5" disabled>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 640px" type="text" id="edittujuan" name="edittujuan" class="textbox" onchange="getnama(this.value);" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Calibri" color="#000">
				<input style="font-family: Calibri; font-size: 1.0em; width: 640px" type="text" id="edittembusan" name="edittembusan" class="textbox" onchange="getnama(this.value);" tabindex="6">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<div style="text-align:left;margin-top:0%">
	<div class="container2">
		<label class="switch switch-green">
		<input type="checkbox" class="switch-input" id="editjunda" checked>
		<span class="switch-label" data-on="Yes" data-off="No"></span>
		<span class="switch-handle"></span>
		</label>
	</div>
...
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#CAFFEB">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="920px">
			<FONT face="Calibri" color="#000">
				<!--input style="font-family: Calibri; font-size: 0.9em" type="text" id="datepicker-ex30" name="editbbmtglbayar" class="textboxtgl"-->
				<input autocomplete="off" STYLE="padding-left:5px; font-size:0.9em; background-color: #FFFFFF; border:1px solid #ababab; height: 26px; width: 120px" autocomplete="off" class="inp-icon" id="tglperiode1" name="tglperiode1" type="text" tabindex="1" value="<% response.write(tgl1) %>">
<script src="js/jquery-1.11.1.min.js"></script>
<script src="datepicker4/dcalendar.picker.js"></script>
<script>
$('#tglperiode1').dcalendarpicker();
$('#calendar-demo').dcalendar(); //creates the calendar
</script>
			&nbsp;&nbsp; s/d &nbsp;&nbsp;
				<input autocomplete="off" STYLE="padding-left:5px; font-size:0.9em; background-color: #FFFFFF; border:1px solid #ababab; height: 26px; width: 120px" autocomplete="off" class="inp-icon" id="tglperiode2" name="tglperiode2" type="text" tabindex="2" value="<% response.write(tgl2) %>">
<script src="js/jquery-1.11.1.min.js"></script>
<script src="datepicker4/dcalendar.picker.js"></script>
<script>
$('#tglperiode2').dcalendarpicker();
$('#calendar-demo').dcalendar(); //creates the calendar
</script>
			</FONT>
		</td>
...
<table id="uploadbtntab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
	<tr height="38px" align="left">
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="270px">
			<a href="#" class="css-button-3" onclick="uploaddatabaru();">
				<span class="css-button-3-text"><FONT face="Tahoma" size="2">Upload Data File (Excel)</FONT></span>
			</a>
		</td>
...
<table id="barubtntab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
	<tr height="38px" align="left">
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="140px">
			<a href="#" class="css-button-4" onclick="exportcsv();">
				<span class="css-button-4-icon"><i class="fa fa-plus" aria-hidden="true" id="i_pos"></i></span>
				<span class="css-button-4-text"><FONT face="Tahoma" size="2">Export to CSV</FONT></span>
			</a>
		</td>
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="90px"><b>JENIS</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="120px"><b>NO SURAT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="350px"><b>PERIHAL</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="270px"><b>TUJUAN</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="75px"><b>EDIT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="75px"><b>HAPUS</b></td>		
	</tr>
...
%>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (jenissuratxx) %></td>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (tujuanxx) %></td>

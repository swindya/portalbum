...
function savebaru()
{
	...
	if (tgl.length < 5)
	{
		alert("Field tgl masih kosong. Silahkan isi tgl");
		return false;
	}
...
function hapusver(adaid, id)
{
	...
	{
		document.getElementsByName("madaid")[0].value = adaid;
...
<script>
function gotousul(jenisada, jenisang)
{
	if (jenisang=="0" || jenisada=="1" || jenisada.length < 2 || jenisang.length < 2)
	{
		alert("Isi field yg wajib dan kemudian klik tombol simpan terlebih dahulu");
		return false;
	}
	else
	{
		document.forms["gotousulfrm"].submit();
	}
}
</script>
...
<%
    ...
    'results As String
	Dim a, aaa, b, bb, c, d, f, g, jmla, jmldata as integer
	Dim user0 as string
	Dim pwd0 as string
...
'-----------------------------------------------------------------
			...
			End If
			If userid=0 Then
				If NOT Request.Form("ijinuserid") is Nothing Then
					userid = Val(Request.Form("ijinuserid"))
				End If			
			End If
			If userid = 0 Then
				userid = idq
...
'-----------------------------------------------------------------
			...
			End If
			If mohonid = 0 Then
				If NOT Request.Form("ijinadaid") is Nothing Then
					mohonid = Val(Request.Form("ijinadaid"))
				End If
			End If			
			If mohonid = 0 Then
				If Request.QueryString("padaid") Then
...
'-----------------------------------------------------------------
			...
			If statusnext = 0 Then
				If NOT Request.Form("statusmohon") is Nothing Then
					 statusnext = Val(Request.Form("statusmohon"))
...
'==============================================================================
			...
			jmlver = a
			If a > 0 Then 
				If jenisverxx(jmlver).ToUpper()="VERIFIKASI PENGELOLA" AND statusxx(jmlver).ToUpper()="OK" Then
					statusverok = 1
				End If
			End If
'response.write(jenisverxx(jmlver) & "--" & statusxx(jmlver) & "++" & statusverok & "++" & statusnext)
'==============================================================================
...
'==============================================================================
			...
			End If
'response.write("----------------------------" & statusrejectx & "===" & statusnext)			
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">VERIFIKASI PENGADAAN</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="960px" border="0" cellspacing="0" cellpadding="0">
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#44AA44">>> VIEW / UPDATE</FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="35px">
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top" width="300px">
			<FONT face="Arial" color="#000">
				Tgl 
			</FONT>											
		</td>
		<td style="padding-left: 0px; text-align: left; font-size: 1.0em; vertical-align: top" width="30px">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
				...
				<input autocomplete="off" STYLE="padding-left:5px; font-size:1.0em; border:1px solid #ababab; height: 26px; width: 120px" autocomplete="off" class="tcal" id="edittgl" name="edittgl" type="text" value="<% response.write(tglxx) %>" tabindex="1">
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 150px" id="soflow21" name="edittahun" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="<% Response.Write(tahunwingi)%>" 
<% 	If tahunwingi=tahunx Then 
		response.write("selected")
	End If 
%>><% Response.Write(tahunwingi)%></option>
				<option value="<% Response.Write(tahuniki)%>"
<% 	If tahuniki=tahunx Then 
		response.write("selected")
	End If 
%>><% Response.Write(tahuniki)%></option>
				<option value="<% Response.Write(tahunsesuk)%>"
<% 	If tahunsesuk=tahunx Then 
		response.write("selected")
	End If 
%>><% Response.Write(tahunsesuk)%></option>
			</select>			
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 180px" id="soflow22" name="editjenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="">&nbsp;&nbsp;</option>
				<option value="SENTRALISASI" 
<% 	If jenisx="SENTRALISASI" Then 
		response.write("selected") 
	End If 
%>>SENTRALISASI</option>
				<option value="DESENTRALISASI" 
<% 	If jenisx="DESENTRALISASI" Then 
		response.write("selected") 
	End If 
%>>DESENTRALISASI</option>
			</select>			
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top;">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 55px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editnama" name="editnama" rows="3" cols="81" tabindex="3"><% response.write(namax) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 1.0em; width: 150px" id="soflow23" name="editjenisanggaran" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="opex" 
<% 
	If jenisangx.ToUpper()="OPEX" Then 
		response.write("selected") 
	End If 
%>>OPEX</option>
				<option value="capex" 
<% 
	If jenisangx.ToUpper()="CAPEX" Then 
		response.write("selected") 
	End If 
%>>CAPEX</option>
			</select>			
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 200px; height: 20px" type="text" id="editnom" name="editnom" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(nilaijml.ToString("#,###")) %>" tabindex="4">
			</FONT>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 200px; height: 20px" type="text" id="edithps" name="edithps" class="textbox" onkeyup="formatnumber(this);" value="<% response.write(nilaihps.ToString("#,###")) %>" tabindex="5">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
			(Rp.)
			</FONT>
			...
			<table valign="top" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: 0px;" width="600px" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					...
					<td style="padding-left: 0px; text-align: left; vertical-align: top" width="200px">
						<FONT face="Arial" color="#000">
<%
					If Not filesuratx is Nothing Then
						If filesuratx.length() > 3 Then
			...
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: 0px;" width="600px" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					...
					<td style="padding-left: 0px; text-align: left; vertical-align: top" width="200px">
						<FONT face="Arial" color="#000">
<%
					If Not fileipx is Nothing Then
						If fileipx.length() > 3 Then
			...
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: 0px;" width="600px" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					...
					<td style="padding-left: 0px; text-align: left; vertical-align: top" width="200px">
						<FONT face="Arial" color="#000">
<%
					If Not filetorx is Nothing Then
						If filetorx.length() > 3 Then
		...
		<td colspan="2" style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: 0px;" width="600px" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					<td style="padding-left: 0px; text-align: left; vertical-align: top" width="400px">
						<FONT face="Arial" color="#000">
							<input style="padding-left: 0px; text-align: left; font-size: 1.0em" id="edituploadImage4" name="edituploadImage4" type="file" onchange="editPreviewImage(4);" />
						</FONT>
					</td>
					<td style="padding-left: 0px; text-align: left; vertical-align: top" width="200px">
						<FONT face="Arial" color="#000">
...
<table id="verifikasiheadertab" bordercolor="#EFEFEF" style="text-align: left; margin-left: 300px; margin-right: auto; margin-top: auto;" border="1" cellspacing="0" cellpadding="0">
...
<table id="btntab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="880px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="40px">
		<td style="padding-left: 0px; text-align: left;" width="180px">
			<a id="batalbtn" href="#" STYLE="font-family: Calibri; font-size: 1.0em;" class="medium button orange" onclick="closeme();"><i class="fa fa-close" aria-hidden="true"></i>&nbsp;&nbsp;Tutup</a>
		</td>
		<td style="padding-left: 0px; text-align: left;" width="180px">
			<a id="simpanbtn" href="#" STYLE="font-family: Calibri; font-size: 1.0em;" class="medium button green" onclick="savebaru();"><i class="fa fa-save" aria-hidden="true"></i>&nbsp;&nbsp;Simpan</a>
		</td>
...
%>
			<a href="#" onclick="gotousul('<% response.write(jenisx) %>','<% response.write(jenisangx) %>');"><img src="./images/nextblue.jpg" alt="Aanwijzing" style="width:60px;height:60px;"></a>
<%
		End If
%>
		</td>
...
<%
		if statusverok = 1 AND statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none; font-size: 1.1em;" onclick="gotousul('<% response.write(jenisx) %>','<% response.write(jenisangx) %>');"><FONT face="Arial" color="#000">Proses Usulan</FONT></a>
<%
		End If
%>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Calibri" color="#000">
				...
				<input autocomplete="off" STYLE="padding-left:5px; font-size:0.9em; border:1px solid #ababab; height: 26px; width: 120px" autocomplete="off" class="tcal" id="edittglaw" name="edittglaw" type="text" tabindex="1">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="80px">										
		</td>
...
<table id="allbtn" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="880px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="0px">
		<td colspan="4">
			<input type="hidden" id="edithps" name="edithps" value="0">
			...
			<input type="hidden" id="ijinnext" name="ijinnext" value="<% response.write(statusnext) %>">
		</td>
	</tr>
</table>
</form>
...
<form name="verdelfrm" id="verdelfrm" method="post" action="prosesmohonverdelgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="verid" name="verid">
	<input type="hidden" id="madaid" name="madaid">
</form>

<form method="post" name="veriffrm" id="veriffrm" action="addprosesvergo.aspx" enctype="multipart/form-data">
...
<form name="gotousulfrm" id="gotousulfrm" action="prosesusulan.aspx" method="post" enctype="multipart/form-data">

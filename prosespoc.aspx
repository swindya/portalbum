...
'-----------------------------------------------------------------------------------
			...
			If mohonid = 0 Then
				If NOT Request.Form("pocadaid") is Nothing Then
					 madaid = Request.Form("pocadaid")
					 mohonid = Val(madaid)
				End If
			End If
			adaid = mohonid
...
'==============================================================================
			SQL3 = "SELECT * FROM pengadaan_poc WHERE pengadaanID=" & mohonid
'response.write(SQL3)
			myCmd.CommandText = SQL3
			myConn.Open()
			myReader = myCmd.ExecuteReader()
			...
			If a=0 Then
				SQL4 = "INSERT INTO pengadaan_poc(pengadaanID, tgl, createduser, createddatetime) VALUES(" & _
...
'response.write(SQL4)
				...
				SQL1 = "UPDATE pengadaan SET step='POC', tglstep=GETDATE() WHERE ID=" & mohonid
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			...
			<FONT face="Arial" color="#000">PROOF OF CONCEPT (POC)</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="editfrm" id="editfrm" action="editprosespocgo.aspx" enctype="multipart/form-data">
...
%>
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:1.0em; vertical-align: top">
			<FONT color="#000">
				<textarea STYLE="font-family: Arial; color: #000000; padding-left: 5px; border:1px solid #ababab; font-size:1.0em; line-height: 110%; height: 50px; width: 680px;" id="editketerangan" name="editketerangan" rows="3" cols="81" tabindex="7"><% response.write(ketx) %></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
<%
		If statusnext=0 Then
%>
			<a href="#" STYLE="text-decoration: none; font-size: 1.1em;" onclick="gotoeval()"><FONT face="Arial" color="#000">Evaluasi Adm & Teknis</FONT></a>
<%
		End If
%>
		</td>
...
<table id="allbtn" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="880px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="0px">
		<td colspan="4">
			...
			<input type="hidden" id="pocnext" name="pocnext" value="<% response.write(statusnext) %>">
		</td>
	</tr>
</table>
</form>

...
function hapusregv(id)
{
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			document.getElementsByName("delregvid")[0].value = id;
...
function hidedatabaru()
{
	...
	document.forms["regvoucherfrm"].submit();
}
</script>
...
function savebaru()
{
	...
	var norekk = document.getElementsByName("barunorekkredit")[0].value;
	var norekd = document.getElementsByName("barunorekdebet")[0].value;
	var rubrik = document.getElementsByName("barurubrik")[0].value;
	var nom = document.getElementsByName("barunominal")[0].value;
	if ((tgl==null || tgl=="") || (jenis==null || jenis=="") || (norekk==null || norekk=="") || (norekd==null || norekd=="") || (rubrik==null || rubrik=="") || (nom==null || nom==""))
	{
...
function saveedit()
{
	...
	var jenis = document.getElementsByName("editjenis")[0].value;
	var norekk = document.getElementsByName("editnorekkredit")[0].value;
	var norekd = document.getElementsByName("editnorekdebet")[0].value;
	var rubrik = document.getElementsByName("editrubrik")[0].value;
	var nom = document.getElementsByName("editnominal")[0].value;
	if ((tgl==null || tgl=="") || (jenis==null || jenis=="") || (norekk==null || norekk=="") || (norekd==null || norekd=="") || (rubrik==null || rubrik=="") || (nom==null || nom==""))
	{
		alert("Mohon lengkapi data terlebih dahulu !");
		return false;
...
<script>
function editdatax(id, nosurat, tgl, jenis, perihal, nokredit, nodebet, rubrik, nominal, namafile, namafolder, extens, statusbum)
{
//alert(id + "-" + tgl);
	document.getElementById("databarutab").style.display = "none";
	...
	if (statusbum==1)
	{
		document.getElementById("uploadfilefrm").style.display = "none";
	}

	document.getElementsByName("editrvid")[0].value = id;
	document.getElementsByName("edittgl")[0].value = tgl;
	//document.getElementsByName("editnomor")[0].value = nosurat;
	document.getElementsByName("editperihal")[0].value = perihal;
	document.getElementsByName("editnorekkredit")[0].value = nokredit;
	document.getElementsByName("editnorekdebet")[0].value = nodebet;
	document.getElementsByName("editnominal")[0].value = nominal;

	document.getElementsByName("editrubrik")[0].value = rubrik;
	document.getElementById("soflow21").value = jenis;
	document.getElementById("soflow22").value = rubrik;
	document.getElementsByName("oldtgl")[0].value = tgl;
	document.getElementsByName("oldnamafile")[0].value = namafile;

	document.getElementById('nomor').innerHTML = nosurat;

	var folderfile = "." + namafolder + namafile;
	if (namafile.length < 2)
	{
		folderfile = "./images/nofile.png"
	}
...
<%
	...
	Dim nokreditxx as String = ""
	Dim nodebetxx as String = ""
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If perihal.length()>0 Then
				perihal = perihal.ToUpper()
				perihalq = perihal
				If perihal.Contains("DEBET") Then
					perihal = "D"
				Else If perihal.Contains("KREDIT") Then
					perihal = "K"
				Else If perihal.Contains("INTERN") Then
					perihal = "I"
				End If
				perihalstr = " AND (perihal LIKE '%" & perihal & "%' OR jenis LIKE '%" & perihal & "%' OR norekkredit LIKE '%" & perihal & _
							"%' OR norekdebet LIKE '%" & perihal & "%' OR nomor LIKE '%" & perihal & "%')"
				perihal = perihalq
			End If
			...
			If tgl1.length() > 1 AND String.IsNullOrEmpty(tgl2) Then
				...
				tglstr = " AND tgl='" & tgl10 & "'"
			Elseif String.IsNullOrEmpty(tgl1) AND tgl2.length() > 1 Then
				tglarr = tgl2.Split("-")
				tgl20 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglstr = " AND tgl='" & tgl20 & "'"
			Elseif tgl1.length()>1 AND tgl2.length()>1 Then
				tglarr = tgl1.Split("-")
				tgl10 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglarr = tgl2.Split("-")
				tgl20 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglstr = " AND tgl BETWEEN '" & tgl10 & "' AND '" & tgl20 & "'"
			End If

'============================================================================
' Data SURAT
'============================================================================
			SQL0 = "SELECT ID FROM [regvoucher] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
			SQLexport = "SELECT * FROM [regvoucher] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#000">DAFTAR REGISTRASI VOUCHER</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="barufrm" id="barufrm" action="regvoucheraddgo.aspx" enctype="multipart/form-data">
<%
	If statusbaru=1 Then
%>
...
%>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="700px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 24px; width: 100px" autocomplete="off" type="text" name="barutgl" id="barutgl" class="tcal"  STYLE="color: #000000; background-color: #FFFFFF;" tabindex="1"/>
			</FONT>
		</td>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 130px" id="soflow11" name="barutahun" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 28px;" id="soflow11" name="barujenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="DI" >Debet Intern</option>
				<option value="NK" >Nota Kredit</option>
				<option value="ND" >Nota Debet</option>
			</select>			
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="baruperihal" name="baruperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-left: 10px; text-align: left; font-size: 0.9em; width: 200px; height: 20px;" type="text" id="barunorekdebet" name="barunorekdebet" class="textbox" tabindex="4">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-left: 10px; text-align: left; font-size: 0.9em; width: 200px; height: 20px;" type="text" id="barunorekkredit" name="barunorekkredit" class="textbox" tabindex="3">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 28px" id="soflow12" name="barurubrik" data-placeholder="Jenis" tabindex="5"> 
				<option value="" >&nbsp;&nbsp;</option>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="text-align: right; font-size: 0.9em; width: 140px; height: 20px;" type="text" id="barunominal" name="barunominal" class="textbox" onkeyup="formatnumber(this);" tabindex="6">
			</FONT>
			...
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					<td style="padding-left: 0px; padding-top: 0px; vertical-align: top; text-align: left; font-size: 1.0em">
						<FONT face="Arial" color="#000">
							<input id="uploadImage0" name="uploadImage0" type="file" onchange="PreviewImage(0);" onclick="resetpic();" tabindex="7"  />
						</FONT>
					</td>
	...
	<tr height="40px">
		<td style="padding-left: 0px; text-align: left;">
			<a id="batalbtn" href="#" style="font-family: Arial; font-size: 0.9em" class="medium button orange" onclick="hidedatabaru();"><i class="fa fa-close" aria-hidden="true"></i>&nbsp;&nbsp;Tutup</a>
		</td>
		<td colspan="3" style="padding-left: 0px; text-align: left;">
			<a id="simpanbtn" href="#" style="font-family: Arial; font-size: 0.9em" class="medium button blue" onclick="savebaru();"><i class="fa fa-save" aria-hidden="true"></i>&nbsp;&nbsp;Simpan</a>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4">
...
<form method="post" name="editfrm" id="editfrm" action="regvouchereditgo.aspx" enctype="multipart/form-data">
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="990px" border="0" cellspacing="0" cellpadding="0">
	<tr height="0px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
		</td>
	</tr>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="570px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 24px; width: 100px" autocomplete="off" type="text" name="edittgl" id="edittgl" class="tcal"  STYLE="color: #000000; background-color: #FFFFFF;" tabindex="1"/>
			</FONT>
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 26px;" id="soflow21" name="editjenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="DI" >Debet Intern</option>
				<option value="NK" >Nota Kredit</option>
				<option value="NB" >Nota Debet</option>
			</select>			
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-left: 10px; text-align: left; font-size: 0.9em; width: 200px; height: 20px;" type="text" id="editnorekdebet" name="editnorekdebet" class="textbox" tabindex="4">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="padding-left: 10px; text-align: left; font-size: 0.9em; width: 200px; height: 20px;" type="text" id="editnorekkredit" name="editnorekkredit" class="textbox" tabindex="3">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height: 26px;" id="soflow22" name="editrubrik" data-placeholder="Rubrik" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="DN" >DN</option>
				<option value="KN" >KN</option>
				<option value="DI" >DI</option>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="text-align: right; font-size: 0.9em; width: 140px; height: 20px;" type="text" id="editnominal" name="editnominal" class="textbox" onkeyup="formatnumber(this);" tabindex="5">
			</FONT>
			<FONT face="Arial" color="#000" size="3">
				&nbsp;Rp.
			</FONT>
	...
	<tr height="40px">
		<td style="padding-left: 0px; text-align: left;">
			<a id="batalbtn" href="#" style="font-family: Arial; font-size: 0.9em" class="medium button orange" onclick="hidedataedit();"><i class="fa fa-close" aria-hidden="true"></i>&nbsp;&nbsp;Tutup</a>
		</td>
		<td colspan="3" style="padding-left: 0px; text-align: left;">
			<a id="simpanbtn" href="#" style="font-family: Arial; font-size: 0.9em" class="medium button blue" onclick="saveedit();"><i class="fa fa-save" aria-hidden="true"></i>&nbsp;&nbsp;Simpan</a>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4">
			<input type="hidden" id="editrvid" name="editrvid">
			<input type="hidden" id="oldnamafile" name="oldnamafile">
			<input type="hidden" id="oldtgl" name="oldtgl">
...
%>
<form method="post" name="filterfrm" id="filterfrm" action="regvoucher.aspx" enctype="multipart/form-data">
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#CAFFEB">
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle" width="920px">
			<FONT face="Arial" color="#000">
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 24px; width: 100px" autocomplete="off" type="text" name="tglperiode1" id="tglperiode1" class="tcal"  STYLE="color: #000000; background-color: #FFFFFF;" tabindex="1"/>
			&nbsp;&nbsp; s/d &nbsp;&nbsp;
				<input style="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 24px; width: 100px" autocomplete="off" type="text" name="tglperiode2" id="tglperiode2" class="tcal"  STYLE="color: #000000; background-color: #FFFFFF;" tabindex="1"/>
			</FONT>
		</td>
	</tr>
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				...
				<div>
					...
					<input style="padding-right: 10px; text-align: left; font-size: 0.9em; width: 400px; height: 20px;" type="text" id="perihal" name="perihal" class="textbox" value="<% Response.Write(perihal) %>">
				</div>
			</FONT>
		</td>
	</tr>
...
<%
		If namaklpq.ToUpper() = "BUM" Then
%>
<!--form method="post" name="uploadfilefrm" id="uploadfilefrm" action="suratuploaddatago.aspx" enctype="multipart/form-data">
<table id="uploadbtntab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
	<tr height="38px" align="left">
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="270px">
			<a href="#" class="css-button-3" style="text-decoration: none; font-size: 1.1em" onclick="uploaddatabaru();">
				<span class="css-button-3-text"><FONT face="Calibri">Upload Data File (Excel)</FONT></span>
			</a>
		</td>
...
<table id="barubtntab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
	<tr height="38px" align="left">
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="200px">
		</td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="400px">
		</td>
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="180px">
<%
		If namaklpq.ToUpper() = "BUM" Then
%>
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="60px"><b>NO</b></td>                        
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="110px"><b>TGL SURAT</b></td>            
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="180px"><b>JENIS</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="130px"><b>NO SURAT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="300px"><b>NONE</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="180px"><b>NOMINAL</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="100px"><b>EDIT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="100px"><b>HAPUS</b></td>		
	</tr>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM [regvoucher] WHERE ID=" & idz(i)			
		...
		If myReader.HasRows Then
			While myReader.Read()
				...
				tglxx = myReader("tgl").ToString()
				jenisxx = myReader("jenis").ToString()
				rubrikxx = myReader("rubrik").ToString()
				perihalxx = myReader("perihal").ToString()
				nokreditxx = myReader("norekkredit").ToString()
				nodebetxx = myReader("norekdebet").ToString()
				...
				If jenisxx="DI" OR jenisxx.ToUpper()="DEBET INTERN" Then
					jenisxxx = "DEBET INTERN"
				Else If jenisxx="NK" OR jenisxx.ToUpper()="NOTA KREDIT" Then
					jenisxxx = "NOTA KREDIT"
				End If
			End While
		End If
		myConn.Close()
		...
		'datastrx(i) = idx(i) & ",'" & nosuratx(i) & "','" & tglx(i) & "','" & jenisx(i) & "','" & perihalx(i) & "','" & tujuanx(i) & "','" & _
		...
		datastrxx = idxx & ",'" & nosuratxx & "','" & tglsu & "','" & jenisxx & "','" & perihalxx & "','" & nokreditxx & "','" & nodebetxx & "','" & rubrikxx & "','" & nominalxx.ToString("#,###") & _
						"','" & namafilexx & "','" & namafolderxx & "','" & extens & "'," & statusbum
...
<%
		End If
%>
		<td style="padding-right: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: right; vertical-align: top; line-height: 110%"><% Response.Write (startval+bb) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (tglsu) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (jenisxxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (nosuratxx) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (perihalxx) %></td>
		<td style="padding-right: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: right; vertical-align: top; line-height: 110%"><% Response.Write (nominalxx.ToString("#,###")) %></td>
		...
		<td style="padding-left: 0px; padding-top: 5px; font-family: Calibri; font-size: 0.9em;text-align: center; vertical-align: top;">
			...
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/delete4.png" OnClick="hapusregv(<% Response.Write (idxx) %>);" height="26px" width="25px"/><br/>
		</td>
	</tr>
<%
	next
...
<table id="totalpagetab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1140px" border="0" cellspacing="0" cellpadding="0">
	<tr height="30px">
		<td style="padding-left: 0px; text-align: left; font-size: 0.9em">
			<FONT face="Arial" color="#000">Total Hal:&nbsp;<% response.write(jmlpage) %></FONT>
		</td>
	</tr>
	<tr height="10px">
...
<form method="post" name="exportfrm" id="exportfrm" action="regvdownloadgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="regvsql" name="regvsql" value="<% response.write(SQLexport) %>">
</form>

<form method="post" name="delfrm" id="delfrm" action="regvoucherdelgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="delregvid" name="delregvid">
</form>

<form method="post" name="regvoucherfrm" id="regvoucherfrm" action="regvoucher.aspx" enctype="multipart/form-data">
	<input type="hidden" id="statusbaru" name="statusbaru" value="0">
</form>

<form method="post" name="uploaddatafrm" id="uploaddatafrm" action="suratuploaddatago.aspx" enctype="multipart/form-data">
	<input type="hidden" id="upsuratid" name="upsuratid">
</form>

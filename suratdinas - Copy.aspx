...
<%
			...
			jenissuratstr = ""
			If jenissurat.ToUpper() = "SURATJALAN"
				jenissuratstr = " AND (jenissurat='SURAT JALAN'"
			Elseif jenissurat.ToUpper() ="SURATKELUAR"
				jenissuratstr = " AND (jenissurat='SURAT KELUAR'"
			Elseif jenissurat.ToUpper() = "SURATTUGAS"
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="1050px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 50px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>

...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("barunorekkredit") is nothing Then
		nokredit0 = Request.Form("barunorekkredit")
	End If

	If NOT Request.Form("barunorekdebet") is nothing Then
		nodebet0 = Request.Form("barunorekdebet")
	End If
...
'** Cek max value of nomor urut
			...
			SQLjo = "SELECT MAX(nourut) AS maxnourut FROM [regvoucher] WHERE (tahun=" & tahun & ")"
...
'=============================================================================================
			...
			SQL0 = "INSERT INTO regvoucher (nourut, tgl, tglinput, jenis, rubrik, tahun, klp, createduser,perihal," & _
					"norekkredit, norekdebet, nomor, nominal, divisi, createddate, namafile, namafolder) VALUES(" & maxu & ",'" & tgl0 & "','" & _
					tglinputq & "','" & jenis0 & "','" & rubrik0 & "'," & tahun & "," & klpq & "," & idq & ",'" & _
					perihal0 & "','" & nokredit0 & "','" & nodebet0 & "','" & nomorq & "'," & jmlnom & "," & divq & ",'" & 
...
'response.write(SQL0)			
			...
			myConn.Close()
'=============================================================================================			
			SQL2 = "SELECT * FROM [regvoucher] WHERE nomor='" & nomorq & "'"
...
<meta http-equiv="refresh" content="0;url=regvoucherprint.aspx?id=<% response.write(idku) %>" />
</body>
</html>
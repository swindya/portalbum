...
'Waktu -> prefix namafile
	...
	If NOT Request.Form("delpksid") is nothing Then
		pksid = Request.Form("delpksid")
	End If
...
'response.write(SQL1 & "<br>")					
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					tahunxx = Val(myReader("tahun").ToString())
			...
			if tglxx.length() > 5 Then 
				...
				tglxx = format(dt1, "yyyy-M-d")
			End If
			if cdatexx.length() > 5 Then 
				Dim dt1 As DateTime = Convert.ToDateTime(cdatexx)
				cdatexx = format(dt1, "yyyy-M-d")
			End If
'=============================================================================================
' Hapus file
'=============================================================================================
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logpkshapus (pksID, nourut, divisi, klp, jenisada, namapengadaan, nomor, tahun, vendor, nominal, createduser," & _
						"createddate, namafile, namafolder, tglpks, per1, per2, tglhapus, userhapus) VALUES(" & _
						pksid & "," & nourutxx & "," & divisixx & "," & klpxx & ",'" & jenisxx & "','" & namaadaxx & "','" & nopksxx & "'," & tahunxx & _
						",'" & vendorxx & "'," & nominalxx & "," & cuserxx & ",'" & cdatexx & "','" & _
						namafilexx & "','" & namafolderxx & "','" & tglxx & "','" & per1xx & "','" & per2xx & "','" & tglsaiki & "'," & user0 & ")"
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM surat_pks WHERE ID=" & pksid

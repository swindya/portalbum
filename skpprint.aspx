...
<%			
			...
			If NOT Request.QueryString("id") is Nothing Then
				 skpid = Val(Request.QueryString("id"))
			End If
...
<%
			...
			SQL1 = "SELECT * FROM [surat_kp] WHERE ID=" & skpid	
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">SURAT KEPUTUSAN (SK)</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0;" width="1050px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; font-size: 0.9em;  vertical-align: middle" width="400px">
			<FONT face="Arial" color="#000">
<% 
...
%>
	...
	<tr height="38px">
		...
		<td colspan="2" style="padding-left: 0px; text-align: left; font-size: 0.9em; vertical-align: middle">
			<FONT face="Arial" color="#000">
<% 
	response.write(namaketuaxx & " (")
	response.write(ketuajbtnxx & ")")
%>
			</FONT>
		</td>
	</tr>
	...
	<tr height="38px">
		...
		<td colspan="2" style="padding-left: 0px; text-align: left; vertical-align: middle">										
			<FONT face="Arial" color="#000">
<% 
	response.write(namawakaxx & " (")
	response.write(wakajbtnxx & ")") 
%>		
			</FONT>
		</td>
	</tr>
...
<form method="post" name="suratbarufrm" id="suratbarufrm" action="skp.aspx" enctype="multipart/form-data">
...
<form method="post" name="uploaddatafrm" id="uploaddatafrm" action="suratuploaddatago.aspx" enctype="multipart/form-data">
	<input type="hidden" id="upskpid" name="upskpid">
</form>

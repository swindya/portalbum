...
function hapussurat(id)
{
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			document.getElementsByName("delrpid")[0].value = id;
...
function hidedatabaru()
{
	...
	document.forms["regppfrm"].submit();
}
</script>
...
function savebaru()
{
	...
	if ((tgl==null || tgl=="") || (rubrik==null || rubrik=="") || (nom==null || nom==""))
	{
...
<script>
function editdatax(id, nosurat, tgl, perihal, rubrik, nominal, namafile, namafolder, extens, statusbum)
{
//alert(id + "-" + jenisundangan);
	...
	document.getElementsByName("editrpid")[0].value = id;
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If perihal.length()>0 Then
				perihalstr = " AND (nomor LIKE '%" & perihal & "%' OR tujuan LIKE '%" & perihal & "%')"
			End If
...
' Data SURAT
'============================================================================
			SQL0 = "SELECT ID FROM [regpp] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
			SQLExport = "SELECT * FROM [regpp] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tgl DESC"
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#000">DAFTAR REGISTRASI PP</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="barufrm" id="barufrm" action="regppaddgo.aspx" enctype="multipart/form-data">
<%
...
%>
	...
	<!--tr height="65px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="baruperihal" name="baruperihal" rows="2" cols="80" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 140px; height: 28px" id="soflow12" name="barurubrik" data-placeholder="Jenis" tabindex="4"> 
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="text-align: right; font-size: 0.9em; width: 140px; height: 20px;" type="text" id="barunominal" name="barunominal" class="textbox" onkeyup="formatnumber(this);" tabindex="5">
			</FONT>
			<FONT face="Arial" color="#000" size="2">
				&nbsp;Rp.
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
	...
	<tr height="20px">
		<td colspan="3" style="padding-left: 0px; text-align: left; font-size: 0.8em">
			<FONT face="Arial" color="#DD0000">
...
<form method="post" name="editfrm" id="editfrm" action="regppeditgo.aspx" enctype="multipart/form-data">
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="990px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#045CFF"><b>>> VIEW/EDIT DATA</b></FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="680px">
			<FONT face="Arial" color="#000">
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			...
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 140px; height: 26px" id="soflow22" name="editrubrik" data-placeholder="Rubrik" tabindex="4"> 
				<option value="PP" >PP</option>
			</select>		
			</FONT>
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<input style="text-align: right; font-size: 0.9em; width: 140px; height: 19px;" type="text" id="editnominal" name="editnominal" class="textbox" onkeyup="formatnumber(this);" tabindex="5">
			</FONT>
	...
	<tr height="30px">
		<td colspan="4">
			<input type="hidden" id="editrpid" name="editrpid">
...
%>
<form method="post" name="filterfrm" id="filterfrm" action="regpp.aspx" enctype="multipart/form-data">
...
<table id="datatab" style="margin-left: 270px;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<!--td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="130px"><b>JENIS</b></td-->
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="120px"><b>NO SURAT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="550px"><b><BLANK></b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="150px"><b>NOMINAL</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="85px"><b>EDIT</b></td>
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="85px"><b>HAPUS</b></td>		
	</tr>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM [regpp] WHERE ID=" & idz(i)			
		...
		datastrxx = idxx & ",'" & nosuratxx & "','" & tglsu & "','" & perihalxx & "','" & rubrikxx & "','" & nominalxx.ToString("#,###") & _
...
%>
		...
		<!--td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (jenisxx) %></td-->
		<td style="padding-left: 25px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (nosuratxx) %></td>
...
<form method="post" name="exportfrm" id="exportfrm" action="regppdownloadgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="regvsql" name="regvsql" value="<% response.write(SQLexport) %>">
</form>

<form method="post" name="delfrm" id="delfrm" action="regppdelgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="delrpid" name="delrpid">
</form>

<form method="post" name="regppfrm" id="regppfrm" action="regpp.aspx" enctype="multipart/form-data">

...
'=============================================================================================
			SQL1 = "SELECT * FROM surat_sekretaris WHERE (ID=" & suratid & ")"
'response.write(SQL1 & "<br>")					
			...
			If myReader.HasRows Then
				While myReader.Read()
					...
					divisixx = myReader("div").ToString()
...
'=============================================================================================
			...
			If a = 1 Then
				SQL0 = "INSERT INTO logsurathapus (ID, nourut, tglsurat, tglinput, jenis, rubrik, tahun, klp, createduser, tujuan," & _
...
' Hapus data
'=============================================================================================				
				SQLdel = "DELETE FROM surat_sekretaris WHERE ID=" & suratid
...
<meta http-equiv="refresh" content="0;url=suratsekre.aspx?jenis=<% response.write(jenisxx) %>" />
</body>
</html>
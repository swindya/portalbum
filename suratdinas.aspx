...
function hapussurat(id)
{
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			document.getElementsByName("delsuratdinasid")[0].value = id;
...
<script>
function editdatax(id, nosurat, tgl, tahun, jenissurat, perihal, rubrik, tujuan, tembusan, jenisundangan, namafile, namafolder, extens)
{
//alert(id + "-" + nosurat);
	var myfile = "." + namafolder + namafile;
	document.getElementById("databarutab").style.display = "none";
	...
	document.getElementsByName("editperihal")[0].value = perihal.toUpperCase();
	document.getElementsByName("editpengirim")[0].value = nosurat;
	document.getElementsByName("edittujuan")[0].value = tujuan.toUpperCase();

	document.getElementsByName("edittembusan")[0].value = tembusan;
	document.getElementById("soflow21").value = jenissurat;
...
<%
			...
			jenissuratstr = ""
			If jenissurat.ToUpper() = "SURATJALAN" OR jenissurat.ToUpper() = "SURAT JALAN"
				jenissuratstr = " AND (jenissurat='SURAT JALAN'"
			Elseif jenissurat.ToUpper() ="SURATKELUAR" OR jenissurat.ToUpper() ="SURAT KELUAR"
				jenissuratstr = " AND (jenissurat='SURAT KELUAR'"
			Elseif jenissurat.ToUpper() = "SURATTUGAS" OR jenissurat.ToUpper() = "SURAT TUGAS"
				jenissuratstr = " AND (jenissurat='SURAT TUGAS'"
			End If
			
			jenissuratstr = jenissuratstr & " OR jenissurat IS NULL)"
...
'If perihal IsNot Nothing || NOT perihal Is Nothing
			...
			If tgl1.length() > 1 AND String.IsNullOrEmpty(tgl2) Then
				...
				tglstr = " AND tglsuratdinas='" & tgl10 & "'"
			Elseif String.IsNullOrEmpty(tgl1) AND tgl2.length() > 1 Then
				tglarr = tgl2.Split("-")
				tgl20 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglstr = " AND tglsuratdinas='" & tgl20 & "'"
			Elseif tgl1.length()>1 AND tgl2.length()>1 Then
				tglarr = tgl1.Split("-")
				tgl10 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglarr = tgl2.Split("-")
				tgl20 = tglarr(2) & "-" & tglarr(1) & "-" & tglarr(0)
				tglstr = " AND tglsuratdinas BETWEEN '" & tgl10 & "' AND '" & tgl20 & "'"
			End If

'============================================================================
' Cari nama Divisi
'============================================================================
			SQL1 = "SELECT * FROM divisi WHERE (ID=" & divq & ")"
...
' Data SURAT
'============================================================================
			SQL1 = "SELECT ID FROM suratdinas WHERE (ID>0" & jenissuratstr & perihalstr & tglstr & ") ORDER BY tglsuratdinas DESC"
'response.write(SQL1)
			myCmd.CommandText = SQL1
			myConn.Open()
			myReader = myCmd.ExecuteReader()
			...
			myConn.Close()
			jmldata = a
'response.write(levelaksesq & suratq & "<br>")			
'==========================================================================
...
<%
		...
		If jenissurat="suratkeluar" Then
			jenisc = "Surat Keluar"
%>
			<FONT face="Arial" color="#666666">DAFTAR SURAT KELUAR</FONT>
<%
		Elseif jenissurat="suratjalan" Then
			jenisc = "Surat Jalan"
%>
			<FONT face="Arial" color="#666666">DAFTAR SURAT JALAN</FONT>
<%
		Elseif jenissurat="surattugas" Then
			jenisc = "Surat Tugas"
%>
			<FONT face="Arial" color="#666666">DAFTAR SURAT TUGAS</FONT>
<%		
		End If
%>
		</td>
...
<form method="post" name="barufrm" id="barufrm" action="suratdinasaddgo.aspx" enctype="multipart/form-data">
<%
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle;" width="700px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px; height:26px" id="soflow11" name="barujenis" data-placeholder="Jenis" tabindex="1"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="SURAT JALAN" 
				<%
					If jenisc="Surat Jalan" Then
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle" width="340px">
			<FONT face="Arial" color="#000">
				<!--input style="font-family: Arial; font-size: 0.9em" type="text" id="datepicker-ex30" name="editbbmtglbayar" class="textboxtgl"-->
				<input autocomplete="off" STYLE="padding-left:5px; font-size:0.9em; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" class="tcal" id="barutgl" name="barutgl" type="text" tabindex="1" value=<% response.write(strDate) %>>
			</FONT>
		</td>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top;" width="570px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 100px" id="soflow12" name="barutahun" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
		...
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="40px">										
		</td>
	</tr-->
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow11" name="barujenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
	...
	<tr height="60px">
		<td style="padding-left: 0px; padding-top: 0px; text-align: left; font-size: 0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				Perihal
			</FONT>
			<FONT face="Arial" color="#DD0000">
		...
		<td style="padding-left: 0px; padding-top: 0px; text-align: center; font-size: 0.9em; vertical-align: top">
			<FONT face="Arial" color="#000">
				 :
			</FONT>											
		</td>
		<td style="padding-left: 0px; padding-top: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="baruperihal" name="baruperihal" tabindex="3"></textarea>
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 0.9em; width: 100px; height: 18px" type="text" id="barupengirim" name="barupengirim" class="textbox" tabindex="4" value="<% response.write(rubrikz) %>" disabled>
			<!--select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow12" name="barupengirim" data-placeholder="Jenis" tabindex="4"> 
				<option value="" >&nbsp;&nbsp;</option>
<%
...
%>
	...
	<tr height="35px">
		...
		<td style="padding-left: auto; padding-top: 5px; text-align: left; font-size: 1.2em; vertical-align: top">
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					<td style="padding-left: 0px; padding-top: 0px; vertical-align: top; text-align: left;">
						<FONT face="Arial" color="#000">
							<input STYLE=" font-size: 0.8em" id="uploadImage0" name="uploadImage0" type="file" onchange="PreviewImage(0);" onclick="resetpic();" tabindex="7"  />
						</FONT>
					</td>
	...
	<tr height="30px">
		<td colspan="4">
			...
			<input type="hidden" id="barurubrik" name="barurubrik" value="<% response.write(rubrikz) %>">
		</td>
	</tr>
</table>
</form>
...
<form method="post" name="editfrm" id="editfrm" action="suratdinaseditgo.aspx" enctype="multipart/form-data">
<%
	If statusbaru=0 Then
%>
...
%>
	...
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 0.9em">
		</td>
	</tr>
	<tr height="35px">
		<td style="padding-left: 0px; text-align: left; font-size: 0.9em; vertical-align: top" width="220px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top;" width="700px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow21" name="editjenis" data-placeholder="Jenis" tabindex="1"> 
				<option value="" >&nbsp;&nbsp;</option>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<!--input style="font-family: Arial; font-size: 0.9em" type="text" id="datepicker-ex30" name="editbbmtglbayar" class="textboxtgl"-->
				<input autocomplete="off" STYLE="padding-left:5px; font-size:0.9em; border:1px solid #ababab; height: 22px; width: 120px" autocomplete="off" class="tcal" id="edittgl" name="edittgl" type="text" tabindex="1" value=<% response.write(strDate) %>>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<!--tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
			<select STYLE="color: #000000; background-color: #ffffff; font-size: 0.9em; width: 150px" id="soflow11" name="editjenis" data-placeholder="Jenis" tabindex="2"> 
				<option value="" >&nbsp;&nbsp;</option>
				<option value="1" >Biasa</option>
				<option value="2" >Rahasia</option>
			</select>			
	...
	<tr height="60px">
		...
		<td style="padding-left: 0px; text-align: left; font-size:1.0em; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 0.9em; width: 140px; height: 18px" type="text" id="editpengirim" name="editpengirim" class="textbox" tabindex="4" value="" disabled>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 0.9em; width: 640px; height: 18px" type="text" id="edittujuan" name="edittujuan" class="textbox" onchange="getnama(this.value);" tabindex="5">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
	...
	<tr height="38px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: middle">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 0.9em; width: 640px; height: 18px" type="text" id="edittembusan" name="edittembusan" class="textbox" onchange="getnama(this.value);" tabindex="6">
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
		...
		<td style="padding-left: auto; padding-top: 5px; text-align: left; font-size: 1.2em; vertical-align: top">
			<table id="file1" style="text-align: left; margin-left: 0px; margin-right: auto; margin-top: auto;" border="0" cellspacing="0" cellpadding="0">
				<tr height="42px">
					<td style="padding-left: 0px; padding-top: 0px; vertical-align: top; text-align: left;">
						<FONT face="Arial" color="#000">
							<input style="font-size: 0.9em" id="uploadImage1" name="uploadImage1" type="file" onchange="PreviewImage(1);" onclick="resetpic();" tabindex="7"  />
						</FONT>
					</td>
					<td style="padding-top: 5px; padding-left: auto; text-align: right; font-size: 1.2em" width="40px">
						<FONT face="Arial" color="#000">
...
<form method="post" name="filterfrm" id="filterfrm" action="suratdinas.aspx" enctype="multipart/form-data">
<%
	If statusbaru=0 Then
%>
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#F1E9FF">
<%
	Else If statusbaru=1 Then
%>
<table id="filtertab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto; display: none" width="1150px" border="0" cellspacing="0" cellpadding="0" bgcolor="#F1E9FF">
<%
	End If
%>
	<tr height="20px">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="920px">
			<FONT face="Arial" color="#000">
				<!--input style="font-family: Arial; font-size: 0.9em" type="text" id="datepicker-ex30" name="editbbmtglbayar" class="textboxtgl"-->
				<input autocomplete="off" STYLE="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" class="tcal" id="tglperiode1" name="tglperiode1" type="text" tabindex="1" value="<% response.write(tgl1) %>">
			&nbsp;&nbsp; s/d &nbsp;&nbsp;
				<input autocomplete="off" STYLE="padding-left:10px; font-size: 0.9em; background-color: #FFF; border:1px solid #ababab; height: 20px; width: 100px" autocomplete="off" class="tcal" id="tglperiode2" name="tglperiode2" type="text" tabindex="2" value="<% response.write(tgl2) %>">
			</FONT>
		</td>
	</tr>
	<tr height="35px">
	...
	<tr height="20px">
		<td colspan="3" style="padding-left: 20px; text-align: left;">
			...
			<input type="hidden" id="editsuratid" name="editsuratid" value="1">
			<input type="hidden" id="pageno" name="pageno" value="1">
			<input type="hidden" id="statusfilter" name="statusfilter" value="0">
			<input type="hidden" id="jenis" name="jenis" value="<% response.write(jenissurat) %>">
		</td>
	</tr>
</table>
</form>
...
<%
	Else If statusbaru=1 Then
%>
<table id="barubtntab" style="margin-left: 270px; display: none" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#EEE" >
<%
	End If
%>
	...
	<tr height="38px" align="left">
		<td style="font-family: Arial; font-size: 0.9em; text-align: left;" width="120px">
			...
			<a href="#" class="css-button-3" style="text-decoration: none; font-size: 1.0em" onclick="databaru();">
				<span class="css-button-3-icon"><i class="fa fa-plus" aria-hidden="true" id="i_pos"></i></span>
				<span class="css-button-3-text"><FONT face="Arial">Data Baru</FONT></span>
			</a>
		</td>
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: left;" width="160px">
			<a href="#" class="css-button-4" style="text-decoration: none; font-size: 1.0em" onclick="eksporcsv();">
				<span class="css-button-4-icon"><i class="fa fa-download" aria-hidden="true" id="i_pos"></i></span>
				<span class="css-button-4-text"><FONT face="Arial">Export to Excel</FONT></span>
			</a>
		</td>
...
<%
	Else If statusbaru=1 Then
%>
<table id="datatab" style="margin-left: 270px; display: none;" width="1150px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
<%
	End If
%>
	...
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="110px"><b>TGL SURAT</b></td>            
		<td style="font-family: Arial; font-size: 0.9em;text-align: center;" width="120px"><b>NO SURAT</b></td>
...
Try
	...
	for i = startval to endval
		ii = ii + k
		bb = bb + 1
		SQL1 = "SELECT * FROM [suratdinas] WHERE ID=" & idz(i)			
		myCmd.CommandText = SQL1
		...
		If myReader.HasRows Then
			While myReader.Read()
				...
				tglxx = myReader("tglsuratdinas").ToString()
		...
		datastrxx = idxx & ",'" & nosuratxx & "','" & tglsu & "'," & tahunxx & ",'" & jenissuratxx & "','" & perihalxx & _
					"','" & rubrikxx & "','" & tujuanxx & "','" & tembusanxx & "','" & jenisundanganxx & "','" & _
					namafilexx & "','" & namafolderxx & "','" & extens & "'"
...
<%
		Elseif n=1 Then
			n = 0
%>
	<tr id="row<% Response.Write(bb)%>" STYLE="background-color: #F7F2FF" height="38px">
<%
		End If
%>
		<td style="padding-right: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: right; vertical-align: top; line-height: 110%"><% Response.Write (ii) %></td>
		...
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (perihalxx.ToUpper()) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Arial; font-size: 0.9em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (tujuanxx.ToUpper()) %></td>
...
<%
	Else If statusbaru=1 Then
%>
<table id="totalpagetab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto; display: none;" width="1140px" border="0" cellspacing="0" cellpadding="0">
<%
	End If
%>
	<tr height="30px">
...
<%
	Else If statusbaru=1 Then
%>
<table id="pagingtab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto; display: none;" width="1100px" border="0" cellspacing="0" cellpadding="0">
<%
	End If
%>
...
<form method="post" name="delfrm" id="delfrm" action="suratdinasdelgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="delsuratdinasid" name="delsuratdinasid">
	<input type="hidden" id="deljenissurat" name="deljenissurat">
</form>

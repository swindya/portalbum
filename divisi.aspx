...
function xxxhapussurat(id)
{
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			var outx;
			var linkx = "divisidelgo.aspx?id="+id;
...
function hapusdiv(id)
{
	...
	if (confirm("Apakah anda ingin hapus data ?") == true) 
	{
		...
		if (tenure == "123") {
			document.getElementsByName("deldivid")[0].value = id;
...
function savebaru()
{
	...
	var namadiv = document.getElementsByName("barunamadiv")[0].value;
	var kodediv = document.getElementsByName("barukodediv")[0].value;

	if (kodediv.length < 2 || namadiv.length < 2)
	{
		alert("Nama/kode Divisi tidak valid. Harap dikoreksi.");
		return false;
	}
...
//Cek apakah user dgn NPP sudah ada
	var outx;
	var linkx = "cekdivisi.aspx?kode="+kodediv;
	xhttp = new XMLHttpRequest();
	xhttp.onreadystatechange = function() {
		if (this.readyState == 4 && this.status == 200) {
			//document.getElementById("txtHint").innerHTML = this.responseText;
			...
			if (outx==1 || outx=="1")
			{
				alert("Kode Divisi: '" + kodediv + "' sudah ada !");
				return false;
			}
			else
			{
...
<script>
function editdatax(id, kodediv, namadiv)
{
	document.getElementById("databarutab").style.display = "none";
	...
	document.getElementsByName("editnamadiv")[0].value = namadiv;
	document.getElementsByName("editkodediv")[0].value = kodediv;
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">DAFTAR DIVISI</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
<form method="post" name="barufrm" id="barufrm" action="divisiaddgo.aspx" enctype="multipart/form-data">
<table id="databarutab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#44AA44">>> DIVISI BARU</FONT>
		</td>
	</tr>
	<tr height="50px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 130px; height: 18px;" type="text" id="barukodediv" name="barukodediv" class="textbox" onchange="getnama(this.value);" tabindex="2">	
			</FONT>
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 560px; height: 18px;" type="text" id="barunamadiv" name="barunamadiv" class="textbox" onchange="getnama(this.value);" tabindex="1">	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
		</td>
...
<form method="post" name="editfrm" id="editfrm" action="divisieditgo.aspx" enctype="multipart/form-data">
<table id="dataedittab" style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: 0; display: none" width="860px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.3em">
			<FONT face="Arial" color="#045CFF"><b>VIEW / EDIT</b></FONT>
		</td>
	</tr>
	<tr height="50px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 130px; height: 18px;" type="text" id="editkodediv" name="editkodediv" class="textbox" onchange="getnama(this.value);" tabindex="2">	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
		</td>
	...
	<tr height="35px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top" width="550px">
			<FONT face="Arial" color="#000">
				<input style="font-family: Arial; font-size: 1.0em; width: 560px; height: 18px;" type="text" id="editnamadiv" name="editnamadiv" class="textbox" onchange="getnama(this.value);" tabindex="1">	
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em" width="100px">										
		</td>
...
%>
<table id="datatab" style="margin-left: 270px;" width="570px" align="center" cellpadding="2" cellspacing="2" border="0" bgcolor="#FAFAFA" >
	<tr height="42px" align="left" style="background-color:#D5D5D5;color:Black;" >
		...
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="340px"><b>NAMA DIVISI</b></td>            
		<td style="font-family: Calibri; font-size: 0.9em;text-align: center;" width="100px"><b>KODE</b></td>
...
Try
	...
	for i = 1 to jmldiv
		...
		datastrxx = dividx(i) & ",'" & namadivx(i) & "','" & namafulldivx(i) & "'"
...
%>
		...
		<td style="padding-left: 10px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: left; vertical-align: top; line-height: 110%"><% Response.Write (namafulldivx(i).ToUpper()) %></td>
		<td style="padding-left: 5px; padding-top: 5px;  font-family: Calibri; font-size: 1.1em;text-align: center; vertical-align: top; line-height: 110%"><% Response.Write (namadivx(i)) %></td>
...
%>
		<td style="padding-left: 0px; padding-top: 5px; font-family: Calibri; font-size: 0.9em;text-align: center; vertical-align: top;">
			...
			<img id="uploadPreview<% Response.Write (i)%>" src="./images/delete4.png" OnClick="hapusdiv(<% Response.Write (dividx(i)) %>);" height="26px" width="25px"/><br/>
		</td>
<%
		End If
%>
...
<form method="post" name="delfrm" id="delfrm" action="divisidelgo.aspx" enctype="multipart/form-data">

...
'** Cek apakah data sudah ada
			SQLjo = "SELECT * FROM [pengadaan_aanwijzing] WHERE (ID=" & aanwijid & ")"
...
'==================================================================================================================
			If dataexist=1 Then
				SQL0 = "UPDATE pengadaan_aanwijzing SET tgl='" & tglx & "', keterangan='" & ket & "', namafolder='" & _
				folder2 & "'" & nfsuratz & nfipz & " WHERE (ID=" & aanwijid & ")"
'response.write(SQL0)
...
<meta http-equiv="refresh" content="0;url=prosesaanwijzing.aspx?padaid=<% response.write(adaid) %>&statusnext=<% response.write(statusnext) %>" />
</body>
</html>
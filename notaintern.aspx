...
function savebaru()
{
	...
	var pengirimlen = pengirim.length;

	if ((tgl==null || tgl=="") || (jenis==null || jenis=="") || (perihal==null || perihal=="") || (tujuan==null || tujuan=="") || (pengirim==null || pengirim=="") || pengirimlen < 4)
	//if ((tgl==null || tgl=="") || (jenis==null || jenis=="") || (perihal==null || perihal=="") || (tujuan==null || tujuan==""))
	{
...
<%
	...
	Dim namakel(10000) as String
	Dim jmlrubiko as Integer = 0
	Dim rubriko(1000) as String
	Dim rubkel(30000) as String
...
'============================================================================
			...
			If Val(levelaksesq)>0 AND Val(suratq)=1 Then
				SQL0 = "SELECT ID FROM [notin] WHERE (ID>0 AND tglnotin!='2023-06-02' " & perihalstr & tglstr & ") ORDER BY tglnotin DESC"
			End If
			SQLexport = "SELECT * FROM [notin] WHERE (ID>0" & perihalstr & tglstr & ") ORDER BY tglnotin ASC,nourut ASC"
'response.write(SQL0)
...
<table style="text-align: left; margin-left: 270px; margin-right: auto; margin-top: auto;" width="950px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.5em">
			<FONT face="Arial" color="#666666">DAFTAR NOTA INTERNAL</FONT>
		</td>
	</tr>
	<tr height="30px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
...
%>
	...
	<tr height="20px">
		<td colspan="4" style="padding-left: 0px; text-align: left; font-size: 1.4em">
			<FONT face="Arial" color="#44AA44">>> NOTA INTERNAL BARU</FONT>
		</td>
	</tr>
	<tr height="40px">
		<td colspan="4" style="padding-left: 20px; text-align: left; font-size: 1.0em">
	...
	<tr height="70px">
		...
		<td style="padding-left: 0px; padding-top: 5px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:1.0em; line-height: 110%;" id="baruperihal" name="baruperihal" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
			...
			<FONT face="Arial" color="#000">
				<div style="text-align:left;margin-middle:0%">
					<div class="container2">
						...
						<input type="checkbox" class="switch-input" id="barujunda" name="barujunda">
...
%>
	...
	<tr height="70px">
		...
		<td style="padding-left: 0px; text-align: left; vertical-align: top">
			<FONT face="Arial" color="#000">
				<textarea STYLE="font-family: Arial; height: 46px; width: 640px; color: #000000; padding-left: 5px; padding-middle: 5px; padding-bottom: 5px; border:1px solid #ababab; font-weight: normal; font-size:0.9em; line-height: 110%;" id="editperihal" name="editperihal" rows="2" cols="70" tabindex="3"></textarea>
			</FONT>
		</td>
		<td style="padding-left: 0px; text-align: center; font-size: 1.2em">										
		</td>
...
'================================================================================		
		...
		datastrxx = idxx & ",'" & notinxx & "','" & tglsu & "','" & jenisxx & "','" & perihalxx & "','" & rubrikxx & "','" & tujuanxx & "','" & _
						...
						extens & "'," & statusbum & ",'" & writenama.ToUpper() & "','" & writenpp & "','" & namaklpxx & "'"
...
<form method="post" name="exportfrm" id="exportfrm" action="notindownloadgo.aspx" enctype="multipart/form-data">
	<input type="hidden" id="notinsql" name="notinsql" value="<% response.write(SQLexport) %>">
</form>
